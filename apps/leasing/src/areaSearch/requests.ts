...
export const fetchAreaSearchListAttributesRequest = (): Generator<
  any,
  any,
  any
> => {
...
export const fetchAreaSearchAttributesRequest = (): Generator<
  any,
  any,
  any
> => {
  return callApi(
    new Request(createUrl("area_search/1/"), {
      method: "OPTIONS",
    }),
  );
};
export const fetchAreaSearchesRequest = (
  params: Record<string, any> | null | undefined,
): Generator<any, any, any> => {
  return callApi(new Request(createUrl("area_search/", params)));
};
export const fetchSingleAreaSearchRequest = (
  id: number,
): Generator<any, any, any> => {
  return callApi(new Request(createUrl(`area_search/${id}/`)));
};
export const editSingleAreaSearchRequest = (
  id: number,
