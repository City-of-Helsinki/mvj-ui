...
class AreaSearchApplicantInfoCheckEdit extends Component<Props, State> {
  state: State = {
    isModalOpen: false,
    modalCheckItem: null,
    checkItemForm: null,
  ...
  render(): JSX.Element {
    ...
    return (
      <div className="AreaSearchApplicantInfoCheckEdit">
        <Row>
...
export default connect(null, {
  change,
})(AreaSearchApplicantInfoCheckEdit) as React.ComponentType<OwnProps>;
