...
export type AreaSearchApplicantInfoCheckFormProps = OwnProps & {
  initialize: (...args: Array<any>) => any;
  attributes: Attributes;
  valid: boolean;
  formValues: Record<string, any>;
  isPreparerDirty: boolean;
  // Needed in AreaSearchApplicantInfoCheckModal componentDidUpdate
  wrappedInstance?: {
    setFocus: (...args: Array<any>) => any;
  };
};

class AreaSearchApplicantInfoCheckForm extends Component<AreaSearchApplicantInfoCheckFormProps> {
...
)(AreaSearchApplicantInfoCheckForm) as React.ComponentType<OwnProps>;
