...
export const fetchAreaNoteList = (
  params: Record<string, any> | null | undefined,
): FetchAreaNoteListAction => createAction("mvj/areaNote/FETCH_ALL")(params);
export const receiveAreaNoteList = (
  areaNote: AreaNoteList,
): ReceiveAreaNoteListAction =>
...
export const receiveDeletedAreaNote = (
  id: AreaNoteId,
): ReceiveDeletedAreaNoteAction =>
  createAction("mvj/areaNote/RECEIVE_DELETED")(id);
export const receiveEditedAreaNote = (
  areaNote: AreaNote,
): ReceiveEditedAreaNoteAction =>
...
export const initializeAreaNote = (
  areaNote: Record<string, any>,
): InitializeAction => createAction("mvj/areaNote/INITIALIZE")(areaNote);
