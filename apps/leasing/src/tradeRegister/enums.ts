...
export const CompanyExtendedFieldPaths = {
  ...
  AUXILIARY_COMPANY_NAMES_LINE_OF_BUSINESS:
    "auxiliaryCompanyName.lineOfBusiness",
  AUXILIARY_COMPANY_NAMES_EXPIRATION_DATE:
    "auxiliaryCompanyName.expirationDate",
  AUXILIARY_COMPANY_NAMES_REGISTRATION_DATE:
    "auxiliaryCompanyName.registrationDate",
  BUSINESS_ID: "businessId",
  COMPANY_EXTENDED: "companyExtended",
  COMPANY_NAME: "companyName",
  COMPANY_NAME_NAME: "companyName.name",
  COMPANY_NAME_EXPIRATION_DATE: "companyName.expirationDate",
  ...
  CONTACT_INFORMATION_POSTAL_STREET_ADDRESS:
    "contactInformation.postal.streetAddress",
  ...
  CONTACT_INFORMATION_VISITATION_COUNTRY:
    "contactInformation.visitation.country",
  CONTACT_INFORMATION_VISITATION_STREET_ADDRESS:
    "contactInformation.visitation.streetAddress",
  CONTACT_INFORMATION_VISITATION_ZIP_CODE:
    "contactInformation.visitation.zipCode",
  DELIVERY_DATE_OF_LAST_FINANCIAL_STATEMENT:
    "deliveryDateOfLastFinancialStatement",
  DOMICILE: "domicile",
  DOMICILE_CODE: "domicile.code",
  DOMICILE_EXPIRATION_DATE: "domicile.expirationDate",
  ...
  HISTORICAL_NAMES_EXPIRATION_DATE:
    "companyName.historicalNames.expirationDate",
  HISTORICAL_NAMES_REGISTRATION_DATE:
    "companyName.historicalNames.registrationDate",
  ...
  PARALLEL_COMPANY_NAMES_EXPIRATION_DATE:
    "companyName.parallelCompanyName.expirationDate",
  PARALLEL_COMPANY_NAMES_REGISTRATION_DATE:
    "companyName.parallelCompanyName.registrationDate",
...
export const CompanyRepresentFieldPaths = {
  ...
  BODY_VALUE_1_NATURAL_PERSON_DATE_OF_BIRTH:
    "body._value_1.naturalPerson.dateOfBirth",
  BODY_VALUE_1_NATURAL_PERSON_FIRSTNAME:
    "body._value_1.naturalPerson.firstname",
  ...
  BODY_VALUE_1_JURISTIC_PERSON_BUSINESS_ID:
    "body._value_1.juristicPerson.businessId",
  BODY_VALUE_1_JURISTIC_PERSON_NAME: "body._value_1.juristicPerson.name",
  BODY_VALUE_1_JURISTIC_PERSON_REGISTER:
    "body._value_1.juristicPerson.register",
  BODY_VALUE_1_JURISTIC_PERSON_REGISTRATION_NUMBER:
    "body._value_1.juristicPerson.registrationNumber",
  ...
  LEGAL_REPRESENTATION_REGISTRATION_DATE:
    "legalRepresentation.registrationDate",
