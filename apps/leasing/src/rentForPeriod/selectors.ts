...
export const getIsFetching: Selector<boolean, void> = (
  state: RootState,
): boolean => state.rentForPeriod.isFetching;
export const getRentForPeriodArrayByLease: Selector<RentForPeriod, LeaseId> = (
  state: RootState,
  leaseId: LeaseId,
): RentForPeriod => {
...
export const getIsSaveClicked: Selector<boolean, void> = (
  state: RootState,
): boolean => state.rentForPeriod.isSaveClicked;
