...
import type {
  ApplicantInfoCheckItemPayload,
  ApplicationState,
  DeleteAttachmentPayload,
  TargetInfoCheckItemPayload,
...
const applicationSlice = createSlice({
  ...
  reducers: {
    ...
    receiveUpdatedApplicantInfoCheckItem: (
      _state,
      _action: PayloadAction<ApplicantInfoCheckItemPayload>,
    ) => {},

    receiveUpdatedTargetInfoCheckItem: (
      _state,
      _action: PayloadAction<TargetInfoCheckItemPayload>,
    ) => {},
    ...
    deleteUploadedAttachment: (
      state,
      _action: PayloadAction<DeleteAttachmentPayload>,
    ) => {
      state.isPerformingFileOperation = true;
    },
