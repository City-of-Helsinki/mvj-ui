...
const attributesReducer: Reducer<Attributes> = handleActions(
  {
    ["mvj/invoiceNote/RECEIVE_ATTRIBUTES"]: (
      state: Attributes,
...
const methodsReducer: Reducer<Methods> = handleActions(
  {
    ["mvj/invoiceNote/RECEIVE_METHODS"]: (
      state: Methods,
...
const listReducer: Reducer<InvoiceNoteList> = handleActions(
  {
    ["mvj/invoiceNote/RECEIVE_ALL"]: (
      state: InvoiceNoteList,
      { payload: invoiceNotes }: ReceiveInvoiceNoteListAction,
    ) => {
      return invoiceNotes;
    },
  },
