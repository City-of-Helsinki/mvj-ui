  ...
  render() {
    ...
    const applicationCount = relatedApplications.filter((application) =>
      application.targets.some(
        (target) => target.identifier === currentPlanUnit.identifier,
      ),
    ).length;
    ...
    const getInfoLinkLanguageDisplayText = (key) => {
      ...
      return (
        languages?.find((language) => language.value === key)?.display_name ||
        key
      );
    };
    ...
    return (
      <Column large={12}>
        <Collapse
          ...
          headerTitle={
            get(currentPlanUnit, "identifier")
              ? `${get(currentPlanUnit, "identifier")} ${get(currentPlanUnit, "plan_unit_status")}`
              : "-"
          }
                ...
                <Column small={12} medium={12} large={2}>
                  <Row>
                    <Column small={4} medium={4} large={12}>
                      ...
                      <FormText>{currentPlanUnit.identifier}</FormText>
                    </Column>
                ...
                <Column small={12} medium={12} large={7}>
                  <Row>
                      ...
                      <FormText>
                        {(currentPlanUnit &&
                          getLabelOfOption(
                            ...
                            currentPlanUnit.plan_unit_intended_use,
                          )) ||
                          "-"}
                      </FormText>
                    </Column>
                    ...
                    <Column small={6} medium={4} large={3}>
                      ...
                      <FormText>
                        {get(plotSearchSite, "lease_management") || "-"}
                      </FormText>
                    </Column>
                    <Column small={6} medium={4} large={6}>
                      {/*
                    ...
                    */}
                    ...
                    <Column small={6} medium={4} large={3}>
                      ...
                      <FormText>
                        {get(plotSearchSite, "lease_financing") || "-"}
                      </FormText>
                    </Column>
                    <Column small={6} medium={4} large={3}>
                      <FormTextTitle>
                      ...
                      <FormText>
                        {(currentPlanUnit &&
                          getLabelOfOption(
                            ...
                            currentPlanUnit.plan_unit_state,
                          )) ||
                          "-"}
                      </FormText>
                    </Column>
                    ...
                    <Column small={6} medium={4} large={4}>
                      ...
                      <FormText>
                        {(currentPlanUnit &&
                          getLabelOfOption(
                            planUnitTypeOptions,
                            currentPlanUnit.plan_unit_type,
                          )) ||
                          "-"}
                      </FormText>
                    </Column>
                    ...
                    <Column small={6} medium={4} large={4}>
                      ...
                      <FormText>
                        {formatDate(
                          get(currentPlanUnit, "plot_division_effective_date"),
                        ) || "-"}
                      </FormText>
                    </Column>
                    <Column small={6} medium={4} large={4}>
                      ...
                      <FormText>
                        {(currentPlanUnit &&
                          getLabelOfOption(
                            ...
                            currentPlanUnit.plot_division_state,
                          )) ||
                          "-"}
                      </FormText>
                    </Column>
