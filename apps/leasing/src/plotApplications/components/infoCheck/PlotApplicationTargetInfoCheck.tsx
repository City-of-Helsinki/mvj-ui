              ...
              <Row role="row" key={index}>
                <Column role="cell" small={4} medium={4} large={2}>
                  <FormText>
                    {getLabelOfOption(
                      typeOptions,
                      management.proposed_management,
                    ) || "-"}
                  </FormText>
                </Column>
                <Column role="cell" small={4} medium={4} large={2}>
          ...
          {values.map((entry, index) => {
            return (
              <Row key={index}>
                <Column small={3} large={4}>
                  <Authorization
                    allow={isFieldAllowedToRead(meetingMemoAttributes, "name")}
                  >
  ...
  render(): JSX.Element {
    ...
    return (
      <PlotApplicationInfoCheckCollapse
        className="PlotApplicationTargetInfoCheck"
      ...
      >
        <form>
          <Row>
            ...
            >
              <Column small={6} medium={4} large={2}>
                ...
                <FormText>{values.reserved ? "Kyllä" : "Ei"}</FormText>
              </Column>
            </Authorization>
            <Authorization
              allow={isFieldAllowedToRead(
            ...
            >
              <Column small={6} medium={4} large={2}>
                ...
                <FormText>
                  {values.share_of_rental_indicator || "-"} /{" "}
                  {values.share_of_rental_denominator || "-"}
                </FormText>
              </Column>
            </Authorization>
            <Authorization
            ...
            >
              <Column small={6} medium={4} large={2}>
                ...
                <FormText>{formatDate(values.counsel_date) || "-"}</FormText>
              </Column>
            </Authorization>
            <Authorization
              allow={isFieldAllowedToRead(
          ...
          <Row>
            ...
            >
              <Column small={12} medium={12} large={12}>
                <PlotApplicationTargetInfoCheckManagements
                  values={values.proposed_managements}
                  attributes={attributes}
                />
              </Column>
            </Authorization>
          ...
          <Row>
            ...
            >
              <Column small={12} medium={12} large={12}>
                <PlotApplicationTargetInfoCheckConditions
                  values={values.reservation_conditions}
                  attributes={attributes}
                />
              </Column>
            </Authorization>
          ...
          <Row>
            ...
            >
              <Column small={12} medium={12} large={12}>
                ...
                <FormText>{values.arguments || "-"}</FormText>
              </Column>
            </Authorization>
          </Row>
          <Row>
            ...
            >
              <Column small={12} medium={12} large={12}>
                <PlotApplicationTargetInfoCheckMeetingMemos
                  values={values.meeting_memos}
                  attributes={attributes}
...
export default flowRight(
  connect((state: RootState, props: Props) => ({
    ...
    values: getInitialTargetInfoCheckValues(
      getApplicationRelatedPlotSearch(state),
      getApplicationTargetInfoCheckData(state),
      props.targetId,
    ),
  })),
