  ...
  describe("Reducer", () => {
    describe("leaseCreateChargeReducer", () => {
      ...
      it("should update attributes", () => {
        ...
        const state = leaseCreateChargeReducer(
          {},
      ...
      it("should update receivableTypes", () => {
        ...
        const state = leaseCreateChargeReducer(
          {},
          receiveReceivableTypes(dummyReceivableTypes),
        );
        expect(state).to.deep.equal(newState);
      });
    });
  ...
  describe("Helpers", () => {
    describe("receivableTypesFromAttributes", () => {
      it("should filter only active receivableTypes as choices", () => {
        ...
        const { choices } = receivableTypesFromAttributes(
          dummyFieldAttributes,
          dummyReceivableTypes,
        );
