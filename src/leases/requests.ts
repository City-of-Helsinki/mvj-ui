...
export const deleteLease = (leaseId: LeaseId): Generator<any, any, any> => {
  return callApi(
    new Request(createUrl(`lease/${leaseId}/`), {
      method: "DELETE",
    }),
  );
};
export const patchLease = (lease: Lease): Generator<any, any, any> => {
  ...
  const body = JSON.stringify(lease);
  return callApi(
    new Request(createUrl(`lease/${id}/`), {
      method: "PATCH",
      body,
    }),
  );
...
export const createCharge = (
  ...
  return callApi(
    new Request(createUrl(`lease_create_charge/`), {
      method: "POST",
      body,
    }),
  );
...
export const startInvoicing = (leaseId: LeaseId): Generator<any, any, any> => {
  ...
  return callApi(
    new Request(createUrl(`lease_set_invoicing_state/?lease=${leaseId}`), {
      method: "POST",
      body,
    }),
  );
...
export const setRentInfoComplete = (
  ...
  return callApi(
    new Request(
      createUrl(`lease_set_rent_info_completion_state/?lease=${leaseId}`),
      {
        method: "POST",
        body,
      },
...
export const sendEmail = (
  ...
  return callApi(
    new Request(createUrl("send_email/"), {
      method: "POST",
      body,
    }),
  );
