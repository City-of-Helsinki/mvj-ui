...
export type FetchLeasesAction = Action<"mvj/leases/FETCH_ALL", Record<string, any>>;
export type FetchLeasesByBBoxAction = Action<"mvj/leases/FETCH_BY_BBOX", Record<string, any>>;
...
export type CopyDecisionToLeasesAction = Action<"mvj/leases/COPY_DECISION_TO_LEASES", Record<string, any>>;
...
export type ReceiveFormValidFlagsAction = Action<"mvj/leases/RECEIVE_FORM_VALID_FLAGS", Record<string, any>>;
export type ClearFormValidFlagsAction = Action<"mvj/leases/CLEAR_FORM_VALID_FLAGS", void>;
export type ReceiveCollapseStatesAction = Action<"mvj/leases/RECEIVE_COLLAPSE_STATES", Record<string, any>>;
export type FetchLeasesForContractNumberAction = Action<"mvj/leases/FETCH_LEASES_FOR_CONTRACT_NUMBERS", Record<string, any>>;
