...
import { receiveCollapseStates, fetchLeasesForContractNumber } from "leases/actions";
import { ConfirmationModalTexts, FormNames, ViewModes } from "enums";
import { ButtonColors } from "components/enums";
import { LeaseContractChangesFieldPaths, LeaseContractChangesFieldTitles, LeaseContractCollateralsFieldPaths, LeaseContractCollateralsFieldTitles, LeaseContractsFieldPaths, LeaseContractsFieldTitles } from "leases/enums";
...
import { getAttributes, getCollapseStateByKey, getCurrentLease, getErrorsByFormName, getIsSaveClicked, getIsFetchingLeasesForContractNumbers, getLeasesForContractNumbers } from "leases/selectors";
...
const renderContractChanges = ({
  ...
  return <AppConsumer>
      ...
      return <Collapse className='collapse__secondary' defaultOpen={collapseState !== undefined ? collapseState : true} hasErrors={isSaveClicked && !isEmpty(contractChangeErrors)} headerTitle={title} onToggle={handleCollapseToggle} enableUiDataEdit uiDataKey={getUiDataLeaseKey(LeaseContractChangesFieldPaths.CONTRACT_CHANGES)}>
            {!hasPermissions(usersPermissions, UsersPermissions.ADD_CONTRACTCHANGE) && (!fields || !fields.length) && <FormText>Ei sopimuksen muutoksia</FormText>}
                        ...
                        <Row>
                          <Column small={6} medium={4} large={2}>
                            <Authorization allow={isFieldAllowedToRead(attributes, LeaseContractChangesFieldPaths.SIGNING_DATE)}>
                              <FormField disableTouched={isSaveClicked} fieldAttributes={getFieldAttributes(attributes, LeaseContractChangesFieldPaths.SIGNING_DATE)} name={`${change}.signing_date`} overrideValues={{
                        label: LeaseContractChangesFieldTitles.SIGNING_DATE
                      }} enableUiDataEdit uiDataKey={getUiDataLeaseKey(LeaseContractChangesFieldPaths.SIGNING_DATE)} />
                            </Authorization>
                          </Column>
                          <Column small={6} medium={4} large={2}>
                            <Authorization allow={isFieldAllowedToRead(attributes, LeaseContractChangesFieldPaths.SIGN_BY_DATE)}>
                              <FormField disableTouched={isSaveClicked} fieldAttributes={getFieldAttributes(attributes, LeaseContractChangesFieldPaths.SIGN_BY_DATE)} name={`${change}.sign_by_date`} overrideValues={{
                        label: LeaseContractChangesFieldTitles.SIGN_BY_DATE
                      }} enableUiDataEdit uiDataKey={getUiDataLeaseKey(LeaseContractChangesFieldPaths.SIGN_BY_DATE)} />
                            </Authorization>
                          </Column>
                          <Column small={6} medium={4} large={2}>
                            <Authorization allow={isFieldAllowedToRead(attributes, LeaseContractChangesFieldPaths.FIRST_CALL_SENT)}>
                              <FormField disableTouched={isSaveClicked} fieldAttributes={getFieldAttributes(attributes, LeaseContractChangesFieldPaths.FIRST_CALL_SENT)} name={`${change}.first_call_sent`} overrideValues={{
                        label: LeaseContractChangesFieldTitles.FIRST_CALL_SENT
                      }} enableUiDataEdit uiDataKey={getUiDataLeaseKey(LeaseContractChangesFieldPaths.FIRST_CALL_SENT)} />
                            </Authorization>
                          </Column>
                          <Column small={6} medium={4} large={2}>
                            <Authorization allow={isFieldAllowedToRead(attributes, LeaseContractChangesFieldPaths.SECOND_CALL_SENT)}>
                              <FormField disableTouched={isSaveClicked} fieldAttributes={getFieldAttributes(attributes, LeaseContractChangesFieldPaths.SECOND_CALL_SENT)} name={`${change}.second_call_sent`} overrideValues={{
                        label: LeaseContractChangesFieldTitles.SECOND_CALL_SENT
                      }} enableUiDataEdit uiDataKey={getUiDataLeaseKey(LeaseContractChangesFieldPaths.SECOND_CALL_SENT)} />
                            </Authorization>
                          </Column>
                          <Column small={6} medium={4} large={2}>
                            <Authorization allow={isFieldAllowedToRead(attributes, LeaseContractChangesFieldPaths.THIRD_CALL_SENT)}>
                              <FormField disableTouched={isSaveClicked} fieldAttributes={getFieldAttributes(attributes, LeaseContractChangesFieldPaths.THIRD_CALL_SENT)} name={`${change}.third_call_sent`} overrideValues={{
                        label: LeaseContractChangesFieldTitles.THIRD_CALL_SENT
                      }} enableUiDataEdit uiDataKey={getUiDataLeaseKey(LeaseContractChangesFieldPaths.THIRD_CALL_SENT)} />
                            </Authorization>
                          </Column>
                        </Row>
                        <Row>
                          <Column small={6} medium={4} large={2}>
                            <Authorization allow={isFieldAllowedToRead(attributes, LeaseContractChangesFieldPaths.DECISION)}>
                              <FormField disableTouched={isSaveClicked} fieldAttributes={getFieldAttributes(attributes, LeaseContractChangesFieldPaths.DECISION)} name={`${change}.decision`} readOnlyValueRenderer={decisionReadOnlyRenderer} overrideValues={{
                        label: LeaseContractChangesFieldTitles.DECISION,
                        options: decisionOptions
                      }} enableUiDataEdit uiDataKey={getUiDataLeaseKey(LeaseContractChangesFieldPaths.DECISION)} />
                            </Authorization>
                          </Column>
                          <Column small={6} medium={8} large={10}>
                            <Authorization allow={isFieldAllowedToRead(attributes, LeaseContractChangesFieldPaths.DESCRIPTION)}>
                              <FormField disableTouched={isSaveClicked} fieldAttributes={getFieldAttributes(attributes, LeaseContractChangesFieldPaths.DESCRIPTION)} name={`${change}.description`} overrideValues={{
                        label: LeaseContractChangesFieldTitles.DESCRIPTION
                      }} enableUiDataEdit uiDataKey={getUiDataLeaseKey(LeaseContractChangesFieldPaths.DESCRIPTION)} />
                            </Authorization>
                          </Column>
                        </Row>
                      </BoxContentWrapper>
...
const renderCollaterals = ({
  ...
  return <AppConsumer>
      ...
      return <Collapse className='collapse__secondary' defaultOpen={collapseState !== undefined ? collapseState : true} hasErrors={isSaveClicked && !isEmpty(collateralsErrors)} headerTitle={title} onToggle={handleCollapseToggle} enableUiDataEdit uiDataKey={getUiDataLeaseKey(LeaseContractCollateralsFieldPaths.COLLATRALS)}>
            {!hasPermissions(usersPermissions, UsersPermissions.ADD_COLLATERAL) && (!fields || !fields.length) && <FormText>Ei vakuuksia</FormText>}
            ...
            return <CollateralEdit key={index} field={field} onRemove={handleRemove} />;
          })}
              </BoxItemContainer>}
            ...
            <Authorization allow={hasPermissions(usersPermissions, UsersPermissions.ADD_COLLATERAL)}>
              <Row>
                <Column>
                  <AddButtonSecondary label='Lisää vakuus' onClick={handleAdd} style={{
                marginTop: !fields.length ? 0 : undefined
              }} />
                </Column>
              </Row>
...
class ContractItemEdit extends Component<Props> {
  ...
  render() {
    ...
    const getContractTitle = (contract: Record<string, any> | null | undefined) => contract ? `${getLabelOfOption(typeOptions, contract.type) || '-'} ${contract.contract_number || ''}` : null;
    ...
    const contractNumberReadOnlyRenderer = value => {
      ...
      return <FormText>{value ? <a onClick={handleShowContractFileModal}>{value}</a> : '-'}</FormText>;
    };
    ...
    return <Collapse defaultOpen={contractCollapseState !== undefined ? contractCollapseState : true} hasErrors={isSaveClicked && !isEmpty(contractErrors)} headerSubtitles={savedContract && <Fragment>
          <Column>
        ...
        </Fragment>} headerTitle={<Authorization allow={isFieldAllowedToRead(attributes, LeaseContractsFieldPaths.TYPE)}>
            {getContractTitle(savedContract) || '-'}
          </Authorization>} onRemove={hasPermissions(usersPermissions, UsersPermissions.DELETE_CONTRACT) ? onRemove : null} onToggle={handleContractCollapseToggle}>
        <BoxContentWrapper>
          <Row>
            <Column small={6} medium={4} large={2}>
              <Authorization allow={isFieldAllowedToRead(attributes, LeaseContractsFieldPaths.TYPE)}>
                <FormField disableTouched={isSaveClicked} fieldAttributes={getFieldAttributes(attributes, LeaseContractsFieldPaths.TYPE)} name={`${field}.type`} overrideValues={{
                label: LeaseContractsFieldTitles.TYPE
              }} enableUiDataEdit uiDataKey={getUiDataLeaseKey(LeaseContractsFieldPaths.TYPE)} />
              </Authorization>
            </Column>
            ...
            <Column small={6} medium={4} large={2}>
              <Authorization allow={isFieldAllowedToRead(attributes, LeaseContractsFieldPaths.SIGNING_DATE)}>
                <FormField disableTouched={isSaveClicked} fieldAttributes={getFieldAttributes(attributes, LeaseContractsFieldPaths.SIGNING_DATE)} name={`${field}.signing_date`} overrideValues={{
                label: LeaseContractsFieldTitles.SIGNING_DATE
              }} enableUiDataEdit uiDataKey={getUiDataLeaseKey(LeaseContractsFieldPaths.SIGNING_DATE)} />
              </Authorization>
            </Column>
          </Row>
          <Row>
            <Column small={6} medium={4} large={2}>
              <Authorization allow={isFieldAllowedToRead(attributes, LeaseContractsFieldPaths.SIGN_BY_DATE)}>
                <FormField disableTouched={isSaveClicked} fieldAttributes={getFieldAttributes(attributes, LeaseContractsFieldPaths.SIGN_BY_DATE)} name={`${field}.sign_by_date`} overrideValues={{
                label: LeaseContractsFieldTitles.SIGN_BY_DATE
              }} enableUiDataEdit uiDataKey={getUiDataLeaseKey(LeaseContractsFieldPaths.SIGN_BY_DATE)} />
              </Authorization>
            </Column>
            <Column small={6} medium={4} large={2}>
              <Authorization allow={isFieldAllowedToRead(attributes, LeaseContractsFieldPaths.FIRST_CALL_SENT)}>
                <FormField disableTouched={isSaveClicked} fieldAttributes={getFieldAttributes(attributes, LeaseContractsFieldPaths.FIRST_CALL_SENT)} name={`${field}.first_call_sent`} overrideValues={{
                label: LeaseContractsFieldTitles.FIRST_CALL_SENT
              }} enableUiDataEdit uiDataKey={getUiDataLeaseKey(LeaseContractsFieldPaths.FIRST_CALL_SENT)} />
              </Authorization>
            </Column>
            <Column small={6} medium={4} large={2}>
              <Authorization allow={isFieldAllowedToRead(attributes, LeaseContractsFieldPaths.SECOND_CALL_SENT)}>
                <FormField disableTouched={isSaveClicked} fieldAttributes={getFieldAttributes(attributes, LeaseContractsFieldPaths.SECOND_CALL_SENT)} name={`${field}.second_call_sent`} overrideValues={{
                label: LeaseContractsFieldTitles.SECOND_CALL_SENT
              }} enableUiDataEdit uiDataKey={getUiDataLeaseKey(LeaseContractsFieldPaths.SECOND_CALL_SENT)} />
              </Authorization>
            </Column>
            <Column small={6} medium={4} large={2}>
              <Authorization allow={isFieldAllowedToRead(attributes, LeaseContractsFieldPaths.THIRD_CALL_SENT)}>
                <FormField disableTouched={isSaveClicked} fieldAttributes={getFieldAttributes(attributes, LeaseContractsFieldPaths.THIRD_CALL_SENT)} name={`${field}.third_call_sent`} overrideValues={{
                label: LeaseContractsFieldTitles.THIRD_CALL_SENT
              }} enableUiDataEdit uiDataKey={getUiDataLeaseKey(LeaseContractsFieldPaths.THIRD_CALL_SENT)} />
              </Authorization>
            </Column>
          </Row>
          <Row>
            {contract ? contract.is_readjustment_decision && <Column small={6} medium={4} large={2}>
              <Authorization allow={isFieldAllowedToRead(attributes, LeaseContractsFieldPaths.IS_READJUSTMENT_DECISION)}>
                <FormField disableTouched={isSaveClicked} fieldAttributes={getFieldAttributes(attributes, LeaseContractsFieldPaths.IS_READJUSTMENT_DECISION)} name={`${field}.is_readjustment_decision`} overrideValues={{
                label: LeaseContractsFieldTitles.IS_READJUSTMENT_DECISION
              }} enableUiDataEdit uiDataKey={getUiDataLeaseKey(LeaseContractsFieldPaths.IS_READJUSTMENT_DECISION)} />
              </Authorization>
            </Column> : null}
            <Column small={6} medium={4} large={2}>
              <Authorization allow={isFieldAllowedToRead(attributes, LeaseContractsFieldPaths.INSTITUTION_IDENTIFIER)}>
                <FormField disableTouched={isSaveClicked} fieldAttributes={getFieldAttributes(attributes, LeaseContractsFieldPaths.INSTITUTION_IDENTIFIER)} name={`${field}.institution_identifier`} overrideValues={{
                label: LeaseContractsFieldTitles.INSTITUTION_IDENTIFIER
              }} enableUiDataEdit uiDataKey={getUiDataLeaseKey(LeaseContractsFieldPaths.INSTITUTION_IDENTIFIER)} />
              </Authorization>
            </Column>
            <Column small={6} medium={4} large={2}>
              <Authorization allow={isFieldAllowedToRead(attributes, LeaseContractsFieldPaths.DECISION)}>
                <FormField disableTouched={isSaveClicked} fieldAttributes={getFieldAttributes(attributes, LeaseContractsFieldPaths.DECISION)} name={`${field}.decision`} readOnlyValueRenderer={decisionReadOnlyRenderer} overrideValues={{
                label: LeaseContractsFieldTitles.DECISION,
                options: decisionOptions
              }} enableUiDataEdit uiDataKey={getUiDataLeaseKey(LeaseContractsFieldPaths.DECISION)} />
              </Authorization>
            </Column>
            <Column small={6} medium={4} large={2}>
              <Authorization allow={isFieldAllowedToRead(attributes, LeaseContractsFieldPaths.INSTITUTION_IDENTIFIER)}>
          ...
          <Row>
            <Column small={12}>
              <Authorization allow={isFieldAllowedToRead(attributes, LeaseContractsFieldPaths.SIGNING_NOTE)}>
                <FormField disableTouched={isSaveClicked} fieldAttributes={getFieldAttributes(attributes, LeaseContractsFieldPaths.SIGNING_NOTE)} name={`${field}.signing_note`} overrideValues={{
                label: LeaseContractsFieldTitles.SIGNING_NOTE
              }} enableUiDataEdit uiDataKey={getUiDataLeaseKey(LeaseContractsFieldPaths.SIGNING_NOTE)} />
              </Authorization>
            </Column>
          </Row>
        </BoxContentWrapper>
        ...
        <Authorization allow={isFieldAllowedToRead(attributes, LeaseContractChangesFieldPaths.CONTRACT_CHANGES)}>
          <FieldArray attributes={attributes} collapseState={contractChangesCollapseState} component={renderContractChanges} currentLease={currentLease} decisionOptions={decisionOptions} errors={errors} name={`${field}.contract_changes`} isSaveClicked={isSaveClicked} onCollapseToggle={handleContractChangesCollapseToggle} title={LeaseContractChangesFieldTitles.CONTRACT_CHANGES} usersPermissions={usersPermissions} />
        </Authorization>

        <Authorization allow={isFieldAllowedToRead(attributes, LeaseContractCollateralsFieldPaths.COLLATRALS)}>
          <FieldArray collapseState={collateralsCollapseState} component={renderCollaterals} errors={errors} name={`${field}.collaterals`} isSaveClicked={isSaveClicked} onCollapseToggle={handleCollateralsCollapseToggle} title={LeaseContractCollateralsFieldTitles.COLLATRALS} usersPermissions={usersPermissions} />
        </Authorization>
      </Collapse>;
  }
