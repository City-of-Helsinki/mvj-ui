  ...
  return (
    <Collapse
      ...
      headerTitle={
        ...
        >
          <>
            {getLabelOfOption(typeOptions, contract.type)}{" "}
    ...
    >
        ...
        <Column small={6} medium={4} large={2}>
          ...
          >
            <>
              ...
              <FormText>
                {formatDate(contract.second_call_sent) || "–"}
              </FormText>
            </>
          </Authorization>
        </Column>
        ...
        <Column small={6} medium={4} large={2}>
          ...
          >
            <>
              ...
              <FormText>{executorName}</FormText>
            </>
          </Authorization>
        </Column>
      </Row>
      ...
      >
        <Collapse
          ...
          defaultOpen={
            contractChangesCollapseState !== undefined
        ...
        >
          {!contract.contract_changes ||
            (!contract.contract_changes.length && (
                      ...
                      <Column small={6} medium={4} large={2}>
                        ...
                        >
                          <>
                            ...
                            <FormText>
                              {formatDate(change.signing_date) || "–"}
                            </FormText>
                          </>
                        </Authorization>
                      </Column>
                      <Column small={6} medium={4} large={2}>
                        ...
                        >
                          <>
                            ...
                            <FormText>
                              {formatDate(change.sign_by_date) || "–"}
                            </FormText>
                          </>
                        </Authorization>
                      </Column>
      ...
      >
        <Collapse
          className="collapse__secondary"
          defaultOpen={
            collateralsCollapseState !== undefined
        ...
        >
          {!contract.collaterals ||
            (!contract.collaterals.length && <FormText>Ei vakuuksia</FormText>)}
