        ...
        <Column small={6} medium={4} large={2}>
          <Authorization allow={isFieldAllowedToRead(attributes, LeaseContractCollateralsFieldPaths.PAID_DATE)}>
            <FormField
              ...
              enableUiDataEdit
              uiDataKey={getUiDataLeaseKey(LeaseContractCollateralsFieldPaths.PAID_DATE)}
            />
          </Authorization>
        </Column>
        <Column small={6} medium={4} large={2}>
          <Authorization allow={isFieldAllowedToRead(attributes, LeaseContractCollateralsFieldPaths.RETURNED_DATE)}>
            <FormField
              ...
              enableUiDataEdit
              uiDataKey={getUiDataLeaseKey(LeaseContractCollateralsFieldPaths.RETURNED_DATE)}
            />
          </Authorization>
        </Column>
      </Row>
        ...
        <Column small={6} medium={4} large={2}>
          <Authorization allow={isFieldAllowedToRead(attributes, LeaseContractCollateralsFieldPaths.NUMBER)}>
            <FormField
              ...
              name={`${field}.number`}
              overrideValues={{label: LeaseContractCollateralsFieldTitles.NUMBER_MORTGAGE_DOCUMENT}}
              enableUiDataEdit
              uiDataKey={getUiDataLeaseKey(LeaseContractCollateralsFieldPaths.NUMBER_MORTGAGE_DOCUMENT)}
            />
          </Authorization>
        </Column>
        <Column small={6} medium={4} large={2}>
          <Authorization allow={isFieldAllowedToRead(attributes, LeaseContractCollateralsFieldPaths.DEED_DATE)}>
            <FormField
              disableTouched={isSaveClicked}
              fieldAttributes={getFieldAttributes(attributes, LeaseContractCollateralsFieldPaths.DEED_DATE)}
              name={`${field}.deed_date`}
              overrideValues={{label: LeaseContractCollateralsFieldTitles.DEED_DATE}}
              enableUiDataEdit
              uiDataKey={getUiDataLeaseKey(LeaseContractCollateralsFieldPaths.DEED_DATE)}
            />
          </Authorization>
        </Column>
        <Column small={6} medium={4} large={2}>
        ...
        <Column small={6} medium={4} large={2}>
          <Authorization allow={isFieldAllowedToRead(attributes, LeaseContractCollateralsFieldPaths.NUMBER)}>
            <FormField
              ...
              enableUiDataEdit
              uiDataKey={getUiDataLeaseKey(LeaseContractCollateralsFieldPaths.NUMBER)}
            />
          </Authorization>
        </Column>
        <Column small={6} medium={4} large={2}>
          <Authorization allow={isFieldAllowedToRead(attributes, LeaseContractCollateralsFieldPaths.START_DATE)}>
            <FormField
              ...
              enableUiDataEdit
              uiDataKey={getUiDataLeaseKey(LeaseContractCollateralsFieldPaths.START_DATE)}
            />
          </Authorization>
        </Column>
        <Column small={6} medium={4} large={2}>
