...
import { getAttributes as getLeaseAttributes, getCurrentLease, getIsSaveClicked } from "leases/selectors";
  ...
  return <AppConsumer>
      ...
      return <BoxItem className='no-border-on-first-child'>
            ...
            <Row>
              <Column small={6} medium={4} large={2}>
                <Authorization allow={isFieldAllowedToRead(leaseAttributes, LeaseInspectionsFieldPaths.INSPECTOR)}>
                  <FormField disableTouched={isSaveClicked} fieldAttributes={getFieldAttributes(leaseAttributes, LeaseInspectionsFieldPaths.INSPECTOR)} name={`${field}.inspector`} overrideValues={{
                label: LeaseInspectionsFieldTitles.INSPECTOR
              }} enableUiDataEdit uiDataKey={getUiDataLeaseKey(LeaseInspectionsFieldPaths.INSPECTOR)} />
                </Authorization>
              </Column>
              <Column small={6} medium={4} large={2}>
                <Authorization allow={isFieldAllowedToRead(leaseAttributes, LeaseInspectionsFieldPaths.SUPERVISION_DATE)}>
                  <FormField disableTouched={isSaveClicked} fieldAttributes={getFieldAttributes(leaseAttributes, LeaseInspectionsFieldPaths.SUPERVISION_DATE)} name={`${field}.supervision_date`} overrideValues={{
                label: LeaseInspectionsFieldTitles.SUPERVISION_DATE
              }} enableUiDataEdit uiDataKey={getUiDataLeaseKey(LeaseInspectionsFieldPaths.SUPERVISION_DATE)} />
                </Authorization>
              </Column>
              <Column small={6} medium={4} large={2}>
                <Authorization allow={isFieldAllowedToRead(leaseAttributes, LeaseInspectionsFieldPaths.SUPERVISED_DATE)}>
                  <FormField disableTouched={isSaveClicked} fieldAttributes={getFieldAttributes(leaseAttributes, LeaseInspectionsFieldPaths.SUPERVISED_DATE)} name={`${field}.supervised_date`} overrideValues={{
                label: LeaseInspectionsFieldTitles.SUPERVISED_DATE
              }} enableUiDataEdit uiDataKey={getUiDataLeaseKey(LeaseInspectionsFieldPaths.SUPERVISED_DATE)} />
                </Authorization>
              </Column>
              <Column small={6} medium={12} large={6}>
                <Authorization allow={isFieldAllowedToRead(leaseAttributes, LeaseInspectionsFieldPaths.DESCRIPTION)}>
                  <FormField disableTouched={isSaveClicked} fieldAttributes={getFieldAttributes(leaseAttributes, LeaseInspectionsFieldPaths.DESCRIPTION)} name={`${field}.description`} enableUiDataEdit tooltipStyle={{
                right: 25
              }} uiDataKey={getUiDataLeaseKey(LeaseInspectionsFieldPaths.DESCRIPTION)} overrideValues={{
            ...
            {inspectionId && <Authorization allow={isFieldAllowedToRead(leaseAttributes, LeaseInspectionAttachmentsFieldPaths.ATTACHMENTS)}>
                ...
                {!hasPermissions(usersPermissions, UsersPermissions.ADD_INSPECTIONATTACHMENT) && !inspectionAttachments.length && <FormText>Ei tiedostoja</FormText>}
