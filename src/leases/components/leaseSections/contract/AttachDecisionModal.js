...
type State = {
  ...
  filter: FilterProps,
  leaseOptions: Array<Object>,
  selectedLeases: Array<Object>,
}
...
class AttachDecisionModal extends PureComponent<Props, State> {
  ...
  handleLeaseListChange = (selected: Array<Object>) => {
    this.setState({selectedLeases: selected});
  }
  ...
  handleCheckboxChange = (value: any) => {
    this.setState({copyConditions: value});
  }
    ...
    return (
      ...
      >
        ...
        <CheckboxInput
          ...
          options={[{value: true, label: 'Liitä myös ehdot'}]}
        />
