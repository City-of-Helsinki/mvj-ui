...
const CustomDetailedPlan = ({ attributes, customDetailedPlan }: Props) => {
  ...
  const infoLinkOptions = getFieldOptions(
    attributes,
    ...
    <BoxItem className="no-border-on-first-child no-border-on-last-child">
        ...
        <Column small={12} medium={4} large={4}>
          ...
          >
            <>
              ...
              <FormText>
                {!isEmptyValue(customDetailedPlan.area)
                  ? `${formatNumber(customDetailedPlan.area)} m²`
                  : "-"}
              </FormText>
            </>
          </Authorization>
        ...
        <Column small={12} medium={4} large={4}>
          ...
          >
            <>
              ...
              <FormText>
                {getLabelOfOption(stateOptions, customDetailedPlan.state) ||
                  "-"}
              </FormText>
            </>
          </Authorization>
        ...
        <Column small={12} medium={4} large={4}>
          ...
          >
            <>
              ...
              <FormText>
                {getLabelOfOption(typeOptions, customDetailedPlan.type) || "-"}
              </FormText>
            </>
          </Authorization>
        </Column>
        ...
        <Column small={12} medium={4} large={4}>
          ...
          >
            <>
              ...
              <FormText>
                {!isEmptyValue(customDetailedPlan.rent_build_permission)
                  ? `${formatNumber(customDetailedPlan.rent_build_permission)} k-m²`
                  : "-"}
              </FormText>
            </>
          </Authorization>
      ...
      {customDetailedPlan.info_links.length > 0 && (
        <Fragment>
          ...
          {customDetailedPlan.info_links.map((info_link) => (
            <Row key={info_link.url}>
              <Column small={4} medium={4} large={4}>
                <Authorization
                  allow={isFieldAllowedToRead(
                    attributes,
              ...
              <Column small={4} medium={4} large={4}>
                ...
                >
                  <FormText>
                    {<ExternalLink href={info_link.url} text={info_link.url} />}
                  </FormText>
                </Authorization>
              </Column>
              <Column small={4} medium={4} large={4}>
                ...
                >
                  <FormText>
                    {getLabelOfOption(infoLinkOptions, info_link.language) ||
                      "-"}
                  </FormText>
                </Authorization>
              </Column>
