...
class PlanUnitItemEdit extends PureComponent<Props & WithRouterProps, State> {
  state = {
    ...
    detailed_plan_latest_processing_date:
      this.props.detailed_plan_latest_processing_date,
    detailed_plan_latest_processing_date_note:
      this.props.detailed_plan_latest_processing_date_note,
  ...
  componentDidUpdate(prevProps: Props) {
    ...
    if (
      ...
      this.state.section_area == this.props.section_area &&
      this.state.detailed_plan_identifier ==
        this.props.detailed_plan_identifier &&
      this.state.detailed_plan_latest_processing_date ==
        this.props.detailed_plan_latest_processing_date &&
      this.state.detailed_plan_latest_processing_date_note ==
        this.props.detailed_plan_latest_processing_date_note &&
      this.state.plot_division_identifier ==
        this.props.plot_division_identifier &&
      this.state.plot_division_state == this.props.plot_division_state &&
      this.state.plot_division_effective_date ==
        this.props.plot_division_effective_date &&
      this.state.plan_unit_type == this.props.plan_unit_type &&
      this.state.plan_unit_state == this.props.plan_unit_state &&
      this.state.plan_unit_intended_use == this.props.plan_unit_intended_use
    ) {
    ...
    if (
      ...
      prevProps.section_area != this.props.section_area ||
      prevProps.detailed_plan_identifier !=
        this.props.detailed_plan_identifier ||
      prevProps.detailed_plan_latest_processing_date !=
        this.props.detailed_plan_latest_processing_date ||
      prevProps.detailed_plan_latest_processing_date_note !=
        this.props.detailed_plan_latest_processing_date_note ||
      prevProps.plot_division_identifier !=
        this.props.plot_division_identifier ||
      prevProps.plot_division_state != this.props.plot_division_state ||
      prevProps.plot_division_effective_date !=
        this.props.plot_division_effective_date ||
      prevProps.plan_unit_type != this.props.plan_unit_type ||
      prevProps.plan_unit_state != this.props.plan_unit_state ||
      prevProps.plan_unit_intended_use != this.props.plan_unit_intended_use
    ) {
...
export default flowRight(
  ...
  connect((state, props) => {
    return {
      ...
      detailed_plan_identifier: selector(
        state,
        `${props.field}.detailed_plan_identifier`,
      ),
      detailed_plan_latest_processing_date: selector(
        state,
        `${props.field}.detailed_plan_latest_processing_date`,
      ),
      detailed_plan_latest_processing_date_note: selector(
        state,
        `${props.field}.detailed_plan_latest_processing_date_note`,
      ),
      plot_division_identifier: selector(
        state,
        `${props.field}.plot_division_identifier`,
      ),
      plot_division_state: selector(
        state,
        `${props.field}.plot_division_state`,
      ),
      plot_division_effective_date: selector(
        state,
        `${props.field}.plot_division_effective_date`,
      ),
      plan_unit_type: selector(state, `${props.field}.plan_unit_type`),
      plan_unit_state: selector(state, `${props.field}.plan_unit_state`),
      plan_unit_intended_use: selector(
        state,
        `${props.field}.plan_unit_intended_use`,
      ),
