...
class PlanUnitItemEdit extends PureComponent<Props, State> {
  ...
  componentDidUpdate(prevProps: Props) {
    ...
    if(this.state.identifier == this.props.identifier &&
      ...
      this.state.detailed_plan_identifier == this.props.detailed_plan_identifier &&
      this.state.detailed_plan_latest_processing_date == this.props.detailed_plan_latest_processing_date &&
      this.state.detailed_plan_latest_processing_date_note == this.props.detailed_plan_latest_processing_date_note &&
      this.state.plot_division_identifier == this.props.plot_division_identifier &&
      this.state.plot_division_state == this.props.plot_division_state &&
      this.state.plot_division_effective_date == this.props.plot_division_effective_date &&
    ...
    if(prevProps.identifier != this.props.identifier ||
      ...
      prevProps.detailed_plan_identifier != this.props.detailed_plan_identifier ||
      prevProps.detailed_plan_latest_processing_date != this.props.detailed_plan_latest_processing_date ||
      prevProps.detailed_plan_latest_processing_date_note != this.props.detailed_plan_latest_processing_date_note ||
      prevProps.plot_division_identifier != this.props.plot_division_identifier ||
      prevProps.plot_division_state != this.props.plot_division_state ||
      prevProps.plot_division_effective_date != this.props.plot_division_effective_date ||
          ...
          <Row>
            ...
            <Column small={12} medium={2} large={2}>
              <Authorization allow={isFieldAllowedToRead(attributes, LeasePlanUnitsFieldPaths.IS_MASTER)}>
                <FormField
                  disableTouched={isSaveClicked}
                  fieldAttributes={getFieldAttributes(attributes,  LeasePlanUnitsFieldPaths.IS_MASTER)}
                  ...
                  enableUiDataEdit
                  uiDataKey={getUiDataLeaseKey(LeasePlanUnitsFieldPaths.IS_MASTER)}
                />
              </Authorization>
            </Column>
            <Column small={12} medium={3} large={3}>
              <Authorization allow={isFieldAllowedToRead(attributes, LeasePlanUnitsFieldPaths.GEOMETRY)}>
                {!isEmpty(geometry) &&
                  <Link to={this.mapLinkUrl}>{LeasePlanUnitsFieldTitles.GEOMETRY}</Link>
                }
              </Authorization>
            </Column>
          </Row>
