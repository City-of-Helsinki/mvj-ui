...
type State = {
  ...
  reservationProcedureOptions: Array<Record<string, any>>;
  specialProjectOptions: Array<Record<string, any>>;
  stateOptions: Array<Record<string, any>>;
  statisticalUseOptions: Array<Record<string, any>>;
  summary: Record<string, any>;
  supportiveHousingOptions: Array<Record<string, any>>;
...
class Summary extends PureComponent<Props, State> {
  ...
  static getDerivedStateFromProps(props: Props, state: State) {
    ...
    if (props.attributes !== state.attributes) {
      ...
      newState.classificationOptions = getFieldOptions(
        props.attributes,
      ...
      newState.hitasOptions = getFieldOptions(
        props.attributes,
      ...
      newState.noticePeriodOptions = getFieldOptions(
        props.attributes,
        LeaseFieldPaths.NOTICE_PERIOD,
      );
      newState.regulationOptions = getFieldOptions(
        props.attributes,
        LeaseFieldPaths.REGULATION,
      );
      newState.reservationProcedureOptions = getFieldOptions(
        props.attributes,
        LeaseFieldPaths.RESERVATION_PROCEDURE,
      );
      newState.specialProjectOptions = getFieldOptions(
        props.attributes,
      ...
      newState.statisticalUseOptions = getFieldOptions(
        props.attributes,
        LeaseFieldPaths.STATISTICAL_USE,
      );
      newState.supportiveHousingOptions = getFieldOptions(
        props.attributes,
                ...
                <Column small={12} medium={6} large={4}>
                  ...
                  >
                    <>
                      ...
                      <FormText>
                        {getLabelOfOption(stateOptions, summary.state) || "-"}
                      </FormText>
                    </>
                  </Authorization>
                </Column>
                ...
                <Column small={12} medium={6} large={4}>
                  ...
                  >
                    <>
                      ...
                      <FormText>
                        {getContactFullName(summary.lessor) || "-"}
                      </FormText>
                    </>
                  </Authorization>
                </Column>
                <Column small={12} medium={6} large={4}>
                  ...
                  >
                    <>
                      ...
                      <FormText>
                        {getUserFullName(summary.preparer) || "-"}
                      </FormText>
                    </>
                  </Authorization>
                </Column>
                ...
                <Column small={12} medium={6} large={4}>
                  ...
                  >
                    <>
                      ...
                      <FormText>
                        {summary.service_unit && summary.service_unit.name
                ...
                <Column small={12} medium={6} large={4}>
                  ...
                  >
                    <>
                      ...
                      <FormText>
                        {(summary.intended_use && summary.intended_use.name) ||
                          "-"}
                      </FormText>
                    </>
                  </Authorization>
                ...
                <Column small={12} medium={6} large={4}>
                  ...
                  >
                    <>
                      ...
                      <FormText>
                        {getLabelOfOption(hitasOptions, summary.hitas) || "-"}
                      </FormText>
                    </>
                  </Authorization>
                </Column>
                ...
                <Column small={12} medium={6} large={4}>
                  ...
                  >
                    <>
                      ...
                      <FormText>
                        {summary.is_subject_to_vat ? "Kyllä" : "Ei"}
                      </FormText>
                    </>
                  </Authorization>
                </Column>
                ...
                <Column small={12} medium={6} large={4}>
                  ...
                  >
                    <>
                      ...
                      <FormText>
                        {!isEmptyValue(summary.building_selling_price)
                          ? `${formatNumber(summary.building_selling_price)} €`
                          : "-"}
                      </FormText>
                    </>
                  </Authorization>
  ...
  (state) => {
    return {
      ...
      collapseStateBasic: getCollapseStateByKey(
        state,
        `${ViewModes.READONLY}.${FormNames.LEASE_SUMMARY}.basic`,
      ),
      collapseStateStatistical: getCollapseStateByKey(
        state,
        `${ViewModes.READONLY}.${FormNames.LEASE_SUMMARY}.statistical`,
      ),
