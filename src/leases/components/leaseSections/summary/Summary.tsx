    ...
    return <Fragment>
        ...
        <Row className='summary__content-wrapper'>
          <Column small={12} medium={8} large={9}>
            <Collapse defaultOpen={collapseStateBasic !== undefined ? collapseStateBasic : true} headerTitle={LeaseFieldTitles.SUMMARY_BASIC_INFO} onToggle={this.handleBasicInfoCollapseToggle} uiDataKey={getUiDataLeaseKey(LeaseFieldPaths.SUMMARY_BASIC_INFO)}>
              <Row>
              ...
              <Row>
                ...
                <Column small={12} medium={6} large={4}>
                  <Authorization allow={hasPermissions(usersPermissions, UsersPermissions.VIEW_BASISOFRENT)}>
                    ...
                    {!matchingBasisOfRents || !matchingBasisOfRents.length ? <FormText>-</FormText> : collapseBasisOfRents ? <ListItems>
                      ...
                      return <ListItem key={`${index}`}>
                          ...
                          <a onClick={this.handleCollapseBasisOfRentsClick} onKeyDown={this.handleCollapseBasisOfRentsKeyDown} tabIndex={0}>
                            ...
                          </a>
                        </ListItems> : <ListItems>
              ...
              <Row>
                <Column small={12} medium={6} large={4}>
                  <Authorization allow={isFieldAllowedToRead(attributes, LeaseFieldPaths.REFERENCE_NUMBER)}>
                    ...
                    <FormText>{summary.reference_number ? <ExternalLink className='no-margin' href={getReferenceNumberLink(summary.reference_number)} text={summary.reference_number} /> : '-'}</FormText>
                  </Authorization>
                </Column>
                <Column small={12} medium={6} large={8}>
            ...
            <Collapse defaultOpen={collapseStateStatistical !== undefined ? collapseStateStatistical : true} headerTitle={LeaseFieldTitles.SUMMARY_STATISTICAL_INFO} onToggle={this.handleStatisticalInfoCollapseToggle} uiDataKey={getUiDataLeaseKey(LeaseFieldPaths.SUMMARY_STATISTICAL_INFO)}>
              <Row>
                <Column small={12} medium={6} large={4}>
