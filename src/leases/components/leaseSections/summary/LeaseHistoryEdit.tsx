...
class LeaseHistoryEdit extends Component<Props, State> {
  ...
  handleCreate = (newHistoryItem: Record<string, any>) => {
    const { createReleatedLease, createRelatedPlotApplication, currentLease } =
      this.props;
    this.setState({
  ...
  render() {
    ...
    const handleDeleteRelatedPlotApplication =
      this.handleDeleteRelatedPlotApplication;
          ...
          return (
            <div className="summary__related-leases">
              ...
              <div className="summary__related-leases_items">
                ...
                {!!currentLease &&
                  renderLeaseWithPlotSearchesAndApplications(
                    currentLease,
                    true,
                  )}
