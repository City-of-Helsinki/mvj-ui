...
import { receiveCollapseStates, receiveFormValidFlags } from "@/leases/actions";
                    ...
                    <>
                      ...
                      <FormText>
                        {summary.service_unit
                          ? summary.service_unit.name || summary.service_unit.id
                          : "-"}
                      </FormText>
                    </>
                  </Authorization>
                  ...
                  >
                    <FormField
                      ...
                      readOnlyValueRenderer={
                        this.referenceNumberReadOnlyRenderer
                      }
                      overrideValues={{
    ...
    (state) => {
      return {
        ...
        collapseStateStatistical: getCollapseStateByKey(
          state,
          `${ViewModes.EDIT}.${formName}.statistical`,
        ),
