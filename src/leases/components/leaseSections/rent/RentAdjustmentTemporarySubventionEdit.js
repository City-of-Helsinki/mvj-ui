    ...
    <Row>
      <Column small={6} medium={4} large={2}>
        <Authorization allow={isFieldAllowedToRead(leaseAttributes, RentAdjustmentTemporarySubventionsFieldPaths.DESCRIPTION)}>
          <FormField
            ...
            fieldAttributes={getFieldAttributes(leaseAttributes, RentAdjustmentTemporarySubventionsFieldPaths.DESCRIPTION)}
            name={`${field}.description`}
            overrideValues={{label: RentAdjustmentTemporarySubventionsFieldTitles.DESCRIPTION}}
            enableUiDataEdit
            invisibleLabel
      ...
      <Column small={4} medium={4} large={2}>
        <Authorization allow={isFieldAllowedToRead(leaseAttributes, RentAdjustmentTemporarySubventionsFieldPaths.SUBVENTION_PERCENT)}>
          <FormField
            disableTouched={isSaveClicked}
            fieldAttributes={getFieldAttributes(leaseAttributes, RentAdjustmentTemporarySubventionsFieldPaths.SUBVENTION_PERCENT)}
            name={`${field}.subvention_percent`}
            overrideValues={{label: RentAdjustmentTemporarySubventionsFieldTitles.SUBVENTION_PERCENT}}
            unit='%'
            invisibleLabel
            enableUiDataEdit
