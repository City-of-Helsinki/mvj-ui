...
const RentAdjustments = ({
  ...
  const decisionOptions = getDecisionOptions(currentLease),
    ...
    amountTypeOptions = getFieldOptions(
      leaseAttributes,
      LeaseRentAdjustmentsFieldPaths.AMOUNT_TYPE,
    ),
    subventionTypeOptions = getFieldOptions(
      leaseAttributes,
      LeaseRentAdjustmentsFieldPaths.SUBVENTION_TYPE,
    ),
    managementTypeOptions = getFieldOptions(
      leaseAttributes,
        ...
        rentAdjustments.map((adjustment, index) => {
          ...
          return (
            ...
            >
                ...
                <Column small={6} medium={4} large={2}>
                  ...
                  >
                    <>
                      ...
                      <FormText>
                        {getLabelOfOption(typeOptions, adjustment.type) || "-"}
                      </FormText>
                    </>
                  </Authorization>
                </Column>
                    ...
                    <Column small={6}>
                      ...
                      >
                        <>
                          ...
                          <FormText>
                            {formatDate(adjustment.start_date) || "-"}
                          </FormText>
                        </>
                      </Authorization>
                    </Column>
              ...
              {adjustment.type === RentAdjustmentTypes.DISCOUNT &&
                            ...
                            <>
                              ...
                              <FormText>
                                {!isEmptyValue(
                                  ...
                                  ? `${formatNumber(adjustment.subvention_base_percent)} %`
                                  : "-"}
                              </FormText>
                            </>
                          </Authorization>
                            ...
                            <>
                              ...
                              <FormText>
                                {!isEmptyValue(
                                  ...
                                  ? `${formatNumber(adjustment.subvention_graduated_percent)} %`
                                  : "-"}
                              </FormText>
                            </>
                          </Authorization>
                    ...
                    <Row>
                      ...
                      <Column small={6} medium={4} large={2}>
                        <FormText className="semibold">
                          {formatNumber(adjustment.full_amount)} %
                        </FormText>
                      </Column>
                    </Row>
                  </GreenBox>
