...
const BasisOfRent = ({
  ...
  const getPlansInspectedText = () => {
    ...
    if (!basisOfRent.plans_inspected_by)
      return formatDate(basisOfRent.plans_inspected_at) || "-";
  ...
  const getDiscountPercentage = () => {
    if (basisOfRent.subvention_type === SubventionTypes.FORM_OF_MANAGEMENT) {
      if (
        basisOfRent.management_subventions &&
        !!basisOfRent.management_subventions.length &&
        basisOfRent.management_subventions[0].subvention_amount
      )
        return calculateBasisOfRentSubventionPercentage(
          basisOfRent.management_subventions[0].subvention_amount,
          currentAmountPerArea,
        );
      return 0;
  ...
  const rentExtra = calculateExtraRent(
  ...
  const fieldsRent = calculateFieldsRent(
    basisOfRent.amount_per_area,
    basisOfRent.area,
  );
  ...
  const mastAreaRent =
    1.5 * calculateFieldsRent(basisOfRent.amount_per_area, basisOfRent.area);
  ...
  const renderIndexFormField = () => (
    ...
    >
      <>
        ...
        <FormText>
          {getLabelOfOption(indexOptions, basisOfRent.index) || "-"}
        </FormText>
      </>
    </Authorization>
  );
  ...
  const renderProfitMarginPercentageFormField = () => (
    ...
    >
      <>
        ...
        <FormText>
          {!isEmptyValue(basisOfRent.profit_margin_percentage)
            ? `${formatNumber(basisOfRent.profit_margin_percentage)} %`
            : "-"}
        </FormText>
      </>
    </Authorization>
      ...
      <BoxContentWrapper>
        <Row>
          <Column small={6} medium={4} large={2}>
            ...
            >
              <>
                ...
                <FormText>
                  {getLabelOfOption(calculatorTypeOptions, calculatorType) ||
                    "-"}
                </FormText>
              </>
            </Authorization>
          ...
          {calculatorType === CalculatorTypes.MAST && (
            <Column large={5} medium={9} small={12}>
              <Row>
                <Column small={6} medium={4} large={2}>
                  <Authorization
                    allow={
                ...
                <Column small={6} medium={4} large={2}>
                  ...
                  >
                    <>
                      ...
                      <FormText>
                        {!isEmptyValue(basisOfRent.amount_per_area)
                          ? `${formatNumber(basisOfRent.amount_per_area)} €`
                          : "-"}
                      </FormText>
                    </>
                  </Authorization>
                ...
                <Column small={6} medium={4} large={2}>
                  ...
                  >
                    <>
                      ...
                      <FormText>
                        {!isEmptyValue(basisOfRent.area)
                          ? `${formatNumber(basisOfRent.area)}`
                          : "-"}
                      </FormText>
                    </>
                  </Authorization>
                ...
                return (
                  <Row key={index}>
                    ...
                    <Column small={6} medium={4} large={2}>
                      ...
                      >
                        <FormText>
                          {!isEmptyValue(child.area)
                            ? `${formatNumber(child.area)}`
                            : "-"}
                        </FormText>
                      </Authorization>
                    </Column>
            ...
            <Column small={6} medium={4} large={2}>
              ...
              >
                <>
                  ...
                  <FormText>
                    {getLabelOfOption(zoneOptions, basisOfRent.zone) || "-"}
                  </FormText>
                </>
              </Authorization>
            </Column>
        ...
        {calculatorType === CalculatorTypes.LEASE && (
          <Row>
            ...
            <Column small={6} medium={4} large={2}>
              {renderIndexFormField()}
            </Column>
            <Column small={6} medium={4} large={2}>
              {renderUnitPriceFormField()}
            </Column>
            <Column small={6} medium={4} large={2}>
              {renderProfitMarginPercentageFormField()}
            </Column>
            <Column small={6} medium={4} large={2}>
              {renderBaseYearRentFormField()}
            </Column>
            <Column small={6} medium={4} large={2}>
              {renderInitialYearRentFormField()}
            </Column>
          </Row>
        )}
        ...
        {(calculatorType === CalculatorTypes.LEASE ||
          ...
          <>
            {(basisOfRent.subvention_type ===
              SubventionTypes.FORM_OF_MANAGEMENT ||
                ...
                <Column small={6} medium={4} large={2}>
                  ...
                  >
                    <>
                      ...
                      <FormText>
                        {!isEmptyValue(discountPercentage)
                ...
                <Column small={12} medium={12} large={12}>
                  ...
                  >
                    <>
                      ...
                      <FormText>
                        {!isEmptyValue(temporarySubventionDiscountPercentage)
            ...
            <Column small={6} medium={4} large={2} hidden>
              ...
              >
                <>
                  ...
                  <FormText>
                    {!isEmptyValue(basisOfRent.discount_percentage)
                      ? `${basisOfRent.discount_percentage} %`
                      : "-"}
                  </FormText>
                </>
              </Authorization>
                            ...
                            return (
                              <Row key={subvention.id}>
                                  ...
                                  >
                                    <FormText>
                                      {!isEmptyValue(
                                        ...
                                        ? `${formatNumber(subvention.subvention_amount)} €`
                                        : "-"}
                                    </FormText>
                                  </Authorization>
                                </Column>
                                <Column small={4} large={2}>
                                  ...
                                  >
                                    <FormText>
                                      {!isEmptyValue(subventionPercent)
                                        ? `${formatNumber(subventionPercent)} %`
                                        : "-"}
                                    </FormText>
                                  </Authorization>
                                </Column>
                  ...
                  <Column small={4} large={2}>
                    ...
                    >
                      <>
                        ...
                        <FormText>
                          {!isEmptyValue(basisOfRent.subvention_base_percent)
                            ? `${formatNumber(basisOfRent.subvention_base_percent)} %`
                            : "-"}
                        </FormText>
                      </>
                    </Authorization>
                      ...
                      <>
                        ...
                        <FormText>
                          {!isEmptyValue(
                            ...
                            ? `${formatNumber(basisOfRent.subvention_graduated_percent)} %`
                            : "-"}
                        </FormText>
                      </>
                    </Authorization>
                        ...
                        return (
                          <Row key={subvention.id}>
                            ...
                            <Column small={4} large={4}>
                              ...
                              >
                                <FormText>
                                  {!isEmptyValue(subvention.subvention_percent)
                                    ? `${formatNumber(subvention.subvention_percent)} %`
                                    : "-"}
                                </FormText>
                              </Authorization>
                            </Column>
