...
const BasicInfoIndexOrManual = ({
  ...
  return <Fragment>
      <Row>
        ...
        {rent.type === RentTypes.INDEX && <Column small={6} medium={4} large={2}>
        ...
        {rent.due_dates_type === RentDueDateTypes.CUSTOM && <Column small={6} medium={4} large={2}>
        ...
        {rent.due_dates_type === RentDueDateTypes.FIXED && <Column small={6} medium={4} large={1}>
        ...
        {rent.due_dates_type === RentDueDateTypes.FIXED && <Column small={6} medium={4} large={2}>
            <Authorization allow={isFieldAllowedToRead(leaseAttributes, LeaseRentDueDatesFieldPaths.DUE_DATES)}>
              <FormTextTitle uiDataKey={getUiDataLeaseKey(LeaseRentsFieldPaths.YEARLY_DUE_DATES)}>
                {LeaseRentsFieldTitles.YEARLY_DUE_DATES}
              </FormTextTitle>
              <FormText>{rent.yearly_due_dates && !!rent.yearly_due_dates.length ? formatDueDates(rent.yearly_due_dates) : 'Ei eräpäiviä'}</FormText>
            </Authorization>
          </Column>}
      </Row>

      {rent.type === RentTypes.MANUAL && <Row>
          {(rent.cycle === RentCycles.JANUARY_TO_DECEMBER || rent.cycle === RentCycles.APRIL_TO_MARCH) && <Column small={6} medium={4} large={2}>
          ...
          {rent.cycle === RentCycles.APRIL_TO_MARCH && <Column small={6} medium={4} large={2}>
      ...
      {oldValuesVisible && <Row>
          ...
          {rent.y_value_start && <Column small={4} medium={2} large={1}>
