  ...
  return (
    <div>
      ...
      {fields && !!fields.length &&
        <Row>
          <Column small={3} medium={2}><label className="mvj-form-field-label">Käyttötarkoitus</label></Column>
          <Column small={3} medium={2}><label className="mvj-form-field-label">Vuokra</label></Column>
          <Column small={2} medium={2}><label className="mvj-form-field-label">Alkupvm</label></Column>
          <Column small={2} medium={2}><label className="mvj-form-field-label">Loppupvm</label></Column>
        </Row>
      }
