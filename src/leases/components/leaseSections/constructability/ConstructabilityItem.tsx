...
const ConstructabilityItem = ({
  ...
  return <Collapse key={area.id} defaultOpen={areaCollapseState !== undefined ? areaCollapseState : true} headerSubtitles={<Fragment>
          <Column>
      ...
      <Collapse className='collapse__secondary' defaultOpen={preconstructionCollapseState !== undefined ? preconstructionCollapseState : false} headerSubtitles={<Authorization allow={isFieldAllowedToRead(attributes, LeaseAreasFieldPaths.PRECONSTRUCTION_STATE)}>
            <Column>
              <StatusIndicator researchState={area.preconstruction_state} stateOptions={constructabilityStateOptions} />
            </Column>
          </Authorization>} headerTitle={LeaseAreasFieldTitles.PRECONSTRUCTION} onToggle={handlePreconstructionCollapseToggle} showTitleOnOpen uiDataKey={getUiDataLeaseKey(LeaseAreasFieldPaths.PRECONSTRUCTION)}>
        <Row>
      ...
      <Collapse className='collapse__secondary' defaultOpen={demolitionCollapseState !== undefined ? demolitionCollapseState : false} headerSubtitles={<Authorization allow={isFieldAllowedToRead(attributes, LeaseAreasFieldPaths.DEMOLITION_STATE)}>
            <Column>
              <StatusIndicator researchState={area.demolition_state} stateOptions={constructabilityStateOptions} />
            </Column>
          </Authorization>} headerTitle={LeaseAreasFieldTitles.DEMOLITION} onToggle={handleDemolitionCollapseToggle} showTitleOnOpen uiDataKey={getUiDataLeaseKey(LeaseAreasFieldPaths.DEMOLITION)}>
        <Row>
          <Column small={6} medium={4} large={2}>
      ...
      <Collapse className='collapse__secondary' defaultOpen={pollutedLandCollapseState !== undefined ? pollutedLandCollapseState : false} headerSubtitles={<Authorization allow={isFieldAllowedToRead(attributes, LeaseAreasFieldPaths.POLLUTED_LAND_STATE)}>
            <Column>
              <StatusIndicator researchState={area.polluted_land_state} stateOptions={constructabilityStateOptions} />
            </Column>
          </Authorization>} headerTitle={LeaseAreasFieldTitles.POLLUTED_LAND} onToggle={handlePollutedLandCollapseToggle} showTitleOnOpen={true} uiDataKey={getUiDataLeaseKey(LeaseAreasFieldPaths.POLLUTED_LAND)}>
        <Row>
          <Column small={6} medium={4} large={2}>
        ...
        <Authorization allow={isFieldAllowedToRead(attributes, LeaseAreaAttachmentsFieldPaths.ATTACHMENTS)}>
          ...
          {!pollutedLandMattiAttachments.length && <FormText>Ei Matti raportteja</FormText>}
      ...
      <Collapse className='collapse__secondary' defaultOpen={constructabilityReportCollapseState !== undefined ? constructabilityReportCollapseState : false} headerSubtitles={<Authorization allow={isFieldAllowedToRead(attributes, LeaseAreasFieldPaths.CONSTRUCTABILITY_REPORT_STATE)}>
            <Column>
              <StatusIndicator researchState={area.constructability_report_state} stateOptions={constructabilityStateOptions} />
            </Column>
          </Authorization>} headerTitle={LeaseAreasFieldTitles.CONSTRUCTABILITY_REPORT} onToggle={handleConstructabilityReportCollapseToggle} showTitleOnOpen uiDataKey={getUiDataLeaseKey(LeaseAreasFieldPaths.CONSTRUCTABILITY_REPORT)}>
        <Row>
          <Column small={6} medium={4} large={2}>
        ...
        <Authorization allow={isFieldAllowedToRead(attributes, LeaseAreaAttachmentsFieldPaths.ATTACHMENTS)}>
          ...
          {!constructabilityReportGeotechnicalAttachments.length && <FormText>Ei geoteknisen palvelun tiedostoja</FormText>}
      ...
      <Collapse className='collapse__secondary' defaultOpen={otherCollapseState !== undefined ? otherCollapseState : false} headerSubtitles={<Authorization allow={isFieldAllowedToRead(attributes, LeaseAreasFieldPaths.OTHER_STATE)}>
            <Column>
              <StatusIndicator researchState={area.other_state} stateOptions={constructabilityStateOptions} />
            </Column>
          </Authorization>} headerTitle={LeaseAreasFieldTitles.OTHER} onToggle={handleOtherCollapseToggle} showTitleOnOpen uiDataKey={getUiDataLeaseKey(LeaseAreasFieldPaths.OTHER)}>
        <Row>
          <Column small={6} medium={4} large={2}>
...
export default connect((state, props) => {
  ...
  return {
    ...
    constructabilityReportCollapseState: getCollapseStateByKey(state, `${ViewModes.READONLY}.${formName}.${id}.constructability_report`),
    demolitionCollapseState: getCollapseStateByKey(state, `${ViewModes.READONLY}.${formName}.${id}.demolition`),
    otherCollapseState: getCollapseStateByKey(state, `${ViewModes.READONLY}.${formName}.${id}.other`),
    pollutedLandCollapseState: getCollapseStateByKey(state, `${ViewModes.READONLY}.${formName}.${id}.polluted_land`),
    preconstructionCollapseState: getCollapseStateByKey(state, `${ViewModes.READONLY}.${formName}.${id}.preconstruction`)
  };
}, {
  receiveCollapseStates
