...
import { formatDate, formatNumber, getFieldAttributes, getFieldOptions, getLabelOfOption, hasPermissions, isEmptyValue, isFieldAllowedToEdit, isFieldAllowedToRead, isFieldRequired } from "/src/util/helpers";
...
const EditInvoiceForm = ({
  ...
  return <form onSubmit={handleSubmit}>
      ...
      <Authorization allow={isFieldAllowedToRead(invoiceAttributes, InvoiceRowsFieldPaths.ROWS)}>
        <FieldArray component={InvoiceRowsEdit} name='rows' isEditClicked={isEditClicked} relativeTo={relativeTo} tenantOptions={tenantOptions} />
      </Authorization>
    </form>;
};
