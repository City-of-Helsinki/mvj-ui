...
import type { PreviewInvoices, ReceivePreviewInvoicesAction } from "/src/previewInvoices/types";
...
const previewInvoicesListReducer: Reducer<PreviewInvoices> = handleActions({
  ['mvj/previewInvoices/RECEIVE_ALL']: (state: PreviewInvoices, {
    payload: previewInvoices
