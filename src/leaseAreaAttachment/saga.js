...
function* createLeaseAreaAttachmentSaga({payload}): Generator<any, any, any> {
  try {
    const {response: {status: statusCode}, bodyAsJson} = yield call(createLeaseAreaAttachment, payload);
...
function* deleteLeaseAreaAttachmentSaga({payload}): Generator<any, any, any> {
  try {
    const {response: {status: statusCode}, bodyAsJson} = yield call(deleteLeaseAreaAttachment, payload.id);
