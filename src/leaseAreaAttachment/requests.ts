...
export const createLeaseAreaAttachment = (
  ...
  return callUploadRequest(
    new Request(createUrl("lease_area_attachment/"), {
      method: "POST",
      body,
    }),
  );
};
export const deleteLeaseAreaAttachment = (
  id: number,
): Generator<any, any, any> => {
  return callApi(
    new Request(createUrl(`lease_area_attachment/${id}/`), {
      method: "DELETE",
    }),
  );
};
