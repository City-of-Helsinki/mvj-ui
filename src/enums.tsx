...
import { DELETE_MODAL_BUTTON_TEXT } from "/src/util/constants";
...
export const ConfirmationModalTexts = {
  ...
  CANCEL_CHANGES: {
    ...
    LABEL: (<span>Lomakkeella on tallentamattomia muutoksia.<br /> Haluatko varmasti poistua tallentamatta?</span> as React.ReactElement<React.ComponentProps<"span">, "span">),
    TITLE: 'Poistu tallentamatta'
  },
  CLOSE_COMMENT_PANEL: {
    BUTTON: 'Sulje kommentointi',
    LABEL: (<span>Kaikkia muutoksia ei ole tallennettu.<br /> Haluatko varmasti sulkea kommentoinnin?</span> as React.ReactElement<React.ComponentProps<"span">, "span">),
  ...
  CREATE_CONTACT: {
    BUTTON: 'Luo asiakas',
    LABEL: (<span>Tunnuksella on jo olemassa asiakas.<br />Haluatko luoda asiakkaan?</span> as React.ReactElement<React.ComponentProps<"span">, "span">),
    TITLE: 'Luo asiakas'
  },
  DELETE_ADDRESS: {
