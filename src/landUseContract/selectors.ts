...
export const getAttributes: Selector<Attributes, void> = (
  state: RootState,
): Attributes => state.landUseContract.attributes;
export const getMethods: Selector<Attributes, void> = (
  state: RootState,
): Methods => state.landUseContract.methods;
export const getIsEditMode: Selector<boolean, void> = (
  state: RootState,
): boolean => state.landUseContract.isEditMode;
export const getIsFetching: Selector<boolean, void> = (
  state: RootState,
): boolean => state.landUseContract.isFetching;
export const getIsFetchingAttributes: Selector<boolean, void> = (
  state: RootState,
): boolean => state.landUseContract.isFetchingAttributes;
export const getIsSaveClicked: Selector<boolean, void> = (
  state: RootState,
): boolean => state.landUseContract.isSaveClicked;
export const getLandUseContractList: Selector<LandUseContractList, void> = (
  state: RootState,
): LandUseContractList => state.landUseContract.list;
export const getCurrentLandUseContract: Selector<LandUseContract, void> = (
  state: RootState,
): LandUseContract => state.landUseContract.current;
export const getIsFormValidById: Selector<boolean, string> = (
  state: RootState,
  id: string,
): boolean => state.landUseContract.isFormValidById[id];
export const getIsFormValidFlags: Selector<Record<string, any>, void> = (
  state: RootState,
): Record<string, any> => state.landUseContract.isFormValidById;
