...
> {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (
      prevProps.landUseContractListData !== this.props.landUseContractListData
    ) {
  ...
  updateTableData = () => {
    ...
    this.setState({
      ...
      landUseContracts: getContentLandUseContractListResults(
  ...
  render() {
    ...
    if (!isMethodAllowed(landUseContractMethods, Methods.GET))
      return (
        <PageContainer>
          <AuthorizationError
            text={PermissionMissingTexts.LAND_USE_CONTRACTS}
          />
        </PageContainer>
      );
    return (
      <PageContainer>
        <Authorization
          allow={isMethodAllowed(landUseContractMethods, Methods.POST)}
        >
