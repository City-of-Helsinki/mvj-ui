...
import { getContactModalSettings, getIsContactFormValid, getIsContactModalOpen, getIsFetching as getIsFetchingContact } from "contacts/selectors";
...
const renderLitigants = ({
  ...
  return <AppConsumer>
      ...
      return <Fragment>
          ...
          return <LitigantItemEdit key={index} field={litigant} index={index} litigants={litigants} onRemove={handleRemove} />;
        })}
            {!archived && <Row>
                <Column>
                  <AddButton className='no-margin' label='Lisää osapuoli' onClick={handleAdd} />
                </Column>
              </Row>}
          </Fragment>;
    }}
  ...
  render() {
    ...
    return <AppConsumer>
        ...
        return <Fragment>
              ...
              <form>
                <FieldArray component={renderLitigants} litigants={litigants} name='activeLitigants' />
                {
              /* Archived tenants */
            }
                <FieldArray component={renderLitigants} archived litigants={litigants} name='archivedLitigants' />
              </form>
            </Fragment>;
      }}
      </AppConsumer>;
