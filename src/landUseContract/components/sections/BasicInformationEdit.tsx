                        ...
                        field={
                          <Authorization
                            allow={isFieldAllowedToRead(
                              attributes,
                              "estate_ids.child.children.estate_id",
                            )}
                          >
                            <>
                              <EstateIdSelectInput
    ...
    return (
      <form>
        ...
        >
          <Row>
            <Authorization
              allow={isFieldAllowedToRead(attributes, "estate_ids")}
            >
              <Column small={6} medium={4} large={2}>
                <FieldArray
                  attributes={attributes}
                    ...
                    <Fragment>
                      <SubTitle
                        ...
                        uiDataKey={getUiDataLandUseAgreementAttachmentKey(
                          LandUseAgreementAttachmentFieldPaths.ATTACHMENTS,
                        )}
                      >
                        {"Liitetiedostot"}
                      </SubTitle>
    ...
    (state) => {
      return {
        ...
        basicInformationCollapseState: getCollapseStateByKey(
          state,
          `${ViewModes.EDIT}.${formName}.basic_information`,
        ),
