          ...
          <Column small={12} large={6}>
            ...
            <WhiteBox>
              ...
              <Row>
                ...
                <Column small={6} medium={3} large={4}>
                  <FormText>
                    {compensations.cash_compensation
                      ? `${formatNumber(compensations.cash_compensation)} €`
                      : "-"}
                  </FormText>
                </Column>
              </Row>
              <Row>
                ...
                <Column small={6} medium={3} large={4}>
                  <FormText>
                    {compensations.land_compensation
                      ? `${formatNumber(compensations.land_compensation)} €`
                      : "-"}
                  </FormText>
                </Column>
              </Row>
              <Row>
                ...
                <Column small={6} medium={3} large={4}>
                  <FormText>
                    {compensations.other_compensation
                      ? `${formatNumber(compensations.other_compensation)} €`
                      : "-"}
                  </FormText>
                </Column>
              </Row>
                ...
                <Column small={6} medium={3} large={4}>
                  <FormText className="no-margin">
                    {compensations.first_installment_increase
                      ? `${formatNumber(compensations.first_installment_increase)} €`
                      : "-"}
                  </FormText>
                </Column>
              </Row>
          ...
          <Column small={12} large={6}>
            ...
            <WhiteBox>
              ...
              <Row>
                ...
                <Column small={6} medium={3} large={4}>
                  <FormText>
                    {compensations.street_acquisition_value
                      ? `${formatNumber(compensations.street_acquisition_value)} €`
                      : "-"}
                  </FormText>
                </Column>
                <Column small={6} medium={3} large={4}>
                  <FormText>
                    {compensations.street_area
                      ? `${formatNumber(compensations.street_area)} m²`
                      : "-"}
                  </FormText>
                </Column>
              </Row>
              <Row>
                ...
                <Column small={6} medium={3} large={4}>
                  <FormText>
                    {compensations.park_acquisition_value
                      ? `${formatNumber(compensations.park_acquisition_value)} €`
                      : "-"}
                  </FormText>
                </Column>
                <Column small={6} medium={3} large={4}>
                  <FormText>
                    {compensations.park_area
                      ? `${formatNumber(compensations.park_area)} m²`
                      : "-"}
                  </FormText>
                </Column>
              </Row>
              <Row>
                ...
                <Column small={6} medium={3} large={4}>
                  <FormText>
                    {compensations.other_acquisition_value
                      ? `${formatNumber(compensations.other_acquisition_value)} €`
                      : "-"}
                  </FormText>
                </Column>
                <Column small={6} medium={3} large={4}>
                  <FormText>
                    {compensations.other_area
                      ? `${formatNumber(compensations.other_area)} m²`
                      : "-"}
                  </FormText>
                </Column>
              </Row>
        ...
        <Row>
          <Column small={12}>
            ...
            <WhiteBox>
              ...
              {compensations.unit_prices_used_in_calculation &&
                compensations.unit_prices_used_in_calculation.map(
                  (calculation, index) => {
                    const sum = getSum(
                      calculation.area,
                      getUsedPrice(
                        calculation.unit_value,
                    ...
                    return (
                      <Row key={index}>
                        <Column large={2}>
                          <FormText>
                            {calculation.usage ? calculation.usage : "-"}
                          </FormText>
                        </Column>
                        <Column large={2}>
                          <FormText>
                        ...
                        <Column large={1}>
                          <FormText>
                            {calculation.unit_value
                              ? `${formatNumber(calculation.unit_value)} €`
                              : "-"}
                          </FormText>
                        </Column>
                        <Column large={1}>
                          <FormText>
                            {calculation.discount
                              ? `${formatNumber(calculation.discount)} €`
                              : "-"}
                          </FormText>
                        </Column>
                        <Column large={1}>
                          <FormText>
                            {calculation.used_price
                              ? `${formatNumber(calculation.used_price)} €`
                              : "-"}
                          </FormText>
                        </Column>
                        <Column large={1}>
