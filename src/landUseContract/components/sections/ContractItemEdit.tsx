...
import { getDecisionById } from "@/landUseContract/helpers";
                          ...
                          <Row>
                            <Column small={6} medium={4} large={2}>
                              <FormFieldLegacy
                                ...
                                fieldAttributes={getFieldAttributes(
                                  attributes,
                                  "contracts.child.children.contract_changes.child.children.decision",
                                )}
                        ...
                        <Row>
                          <Column small={6} medium={4} large={2}>
                            <FormFieldLegacy
                              ...
                              fieldAttributes={getFieldAttributes(
                                attributes,
                                "contracts.child.children.collaterals.child.children.type",
                              )}
                              name={`${warrants}.type`}
                              overrideValues={{
                          ...
                          <Column small={6} medium={4} large={2}>
                            <FormFieldLegacy
                              ...
                              fieldAttributes={getFieldAttributes(
                                attributes,
                                "contracts.child.children.collaterals.child.children.other_type",
                              )}
                          ...
                          <Column small={12} medium={4} large={2}>
                            <FormFieldLegacy
                              ...
                              fieldAttributes={getFieldAttributes(
                                attributes,
                                "contracts.child.children.collaterals.child.children.number",
                              )}
                          ...
                          <Column small={12} medium={4} large={2}>
                            <FormFieldLegacy
                              ...
                              fieldAttributes={getFieldAttributes(
                                attributes,
                                "contracts.child.children.collaterals.child.children.start_date",
                              )}
                          ...
                          <Column small={12} medium={4} large={2}>
                            <FormFieldLegacy
                              ...
                              fieldAttributes={getFieldAttributes(
                                attributes,
                                "contracts.child.children.collaterals.child.children.end_date",
                              )}
                          ...
                          <Column small={12} medium={8} large={10}>
                            <FormFieldLegacy
                              ...
                              fieldAttributes={getFieldAttributes(
                                attributes,
                                "contracts.child.children.collaterals.child.children.note",
                              )}
                              name={`${warrants}.note`}
                              overrideValues={{
                                label: "Huomautus",
        ...
        <Row>
          ...
          <Column small={6} medium={4} large={2}>
            <FormFieldLegacy
              ...
              fieldAttributes={get(
                attributes,
                "contracts.child.children.signing_date",
              )}
          ...
          <Column small={6} medium={4} large={2}>
            <FormFieldLegacy
              ...
              fieldAttributes={get(
                attributes,
                "contracts.child.children.contract_number",
              )}
          ...
          <Column small={6} medium={4} large={2}>
            <FormFieldLegacy
              ...
              fieldAttributes={get(
                attributes,
                "contracts.child.children.area_arrengements",
              )}
...
export default connect(
  (state, props) => {
    ...
    return {
      warrantsCollapseState: getCollapseStateByKey(
        state,
        `${ViewModes.EDIT}.${formName}.${id}.warrants`,
      ),
