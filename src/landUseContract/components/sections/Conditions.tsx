...
const Conditions = ({
  ...
  return <Fragment>
      ...
      <Divider />
      <Collapse defaultOpen={ConditionsCollapseState !== undefined ? ConditionsCollapseState : true} headerTitle='Valvottavat ehdot' onToggle={handleBasicInformationCollapseToggle}>
        {conditions && conditions.map((condition, index) => <Row key={index}>
