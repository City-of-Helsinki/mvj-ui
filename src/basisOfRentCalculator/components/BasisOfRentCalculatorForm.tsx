...
class RentsEdit extends PureComponent<Props> {
  render() {
    ...
    return <form>
        ...
        <Divider />
        <FieldArray archived={false} component={BasisOfRentsEdit} addButtonClass='no-bottom-margin' basisOfRents={basisOfRents} formName={formName} isSaveClicked={false} name="basis_of_rents" showLockedAt={false} showPlansInspectedAt={false} forwardRef />
      </form>;
  }
