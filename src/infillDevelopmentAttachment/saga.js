...
function* createInfillDevelopmentAttachmentSaga({payload}): Generator<any, any, any> {
  try {
    const {response: {status: statusCode}, bodyAsJson} = yield call(createInfillDevelopmentAttachment, payload);
...
function* deleteInfillDevelopmentAttachmentSaga({payload}): Generator<any, any, any> {
  try {
    const {response: {status: statusCode}, bodyAsJson} = yield call(deleteInfillDevelopmentAttachment, payload.fileId);
