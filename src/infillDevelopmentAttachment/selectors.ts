...
export const getAttributes: Selector<Attributes, void> = (
  state: RootState,
): Attributes => state.infillDevelopmentAttachment.attributes;
export const getMethods: Selector<Methods, void> = (
  state: RootState,
): Methods => state.infillDevelopmentAttachment.methods;
export const getIsFetchingAttributes: Selector<boolean, void> = (
  state: RootState,
): boolean => state.infillDevelopmentAttachment.isFetchingAttributes;
