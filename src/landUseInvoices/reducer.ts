...
const isCreatePanelOpenReducer: Reducer<boolean> = handleActions({
  ['mvj/landUseInvoices/RECEIVE_IS_CREATE_PANEL_OPEN']: (state: boolean, {
    payload: isOpen
...
const isCreditPanelOpenReducer: Reducer<boolean> = handleActions({
  ['mvj/landUseInvoices/RECEIVE_IS_CREDIT_PANEL_OPEN']: (state: boolean, {
    payload: isOpen
...
const isCreateClickedReducer: Reducer<boolean> = handleActions({
  ['mvj/landUseInvoices/RECEIVE_CREATE_CLICKED']: (state: boolean, {
    payload: isClicked
...
const isCreditClickedReducer: Reducer<boolean> = handleActions({
  ['mvj/landUseInvoices/RECEIVE_CREDIT_CLICKED']: (state: boolean, {
    payload: isClicked
...
const isEditClickedReducer: Reducer<boolean> = handleActions({
  ['mvj/landUseInvoices/RECEIVE_EDIT_CLICKED']: (state: boolean, {
    payload: isClicked
...
const attributesReducer: Reducer<Attributes> = handleActions({
  ['mvj/landUseInvoices/RECEIVE_ATTRIBUTES']: (state: Attributes, {
    payload: attributes
...
const methodsReducer: Reducer<Methods> = handleActions({
  ['mvj/landUseInvoices/RECEIVE_METHODS']: (state: Methods, {
    payload: methods
...
const byLandUseContractReducer: Reducer<InvoiceListMap> = handleActions({
  ['mvj/landUseInvoices/RECEIVE_BY_LAND_USE_CONTRACT']: (state: InvoiceListMap, {
    payload
...
const invoiceToCreditReducer: Reducer<string | null | undefined> = handleActions({
  ['mvj/landUseInvoices/RECEIVE_INVOICE_TO_CREDIT']: (state: string | null | undefined, {
    payload: invoiceId
...
const patchedInvoiceReducer: Reducer<Invoice | null | undefined> = handleActions({
  ['mvj/landUseInvoices/RECEIVE_PATCHED']: (state: Invoice | null | undefined, {
    payload: invoice
...
const collapseStatesReducer: Reducer<Record<string, any>> = handleActions({
  ['mvj/landUseInvoices/RECEIVE_COLLAPSE_STATES']: (state: Record<string, any>, {
    payload: states
