...
const PaginationPrevious = ({
  ...
  return (
    <li
      className={classNames("pagination__item pagination__previous", {
        disabled: disabled,
      })}
    >
      <a
...
const PaginationNext = ({
  ...
  return (
    <li
      className={classNames("pagination__item pagination__next", {
        disabled: disabled,
      })}
    >
      <a
...
const Pagination = ({ activePage, maxPage, onPageClick }: Props) => {
  ...
  const getPages = () => {
    ...
    // Add second ...
    if (
      (activePage + 2 < maxPage || !(maxPage - activePage < maxShownPages)) &&
      activePage <= maxPage
    ) {
  ...
  return <ul className="pagination">{getPages()}</ul>;
};
