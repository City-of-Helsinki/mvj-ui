  ...
  render(): JSX.Element {
    ...
    return (
      ...
      >
        {showCollapseArrowColumn && (
          <td
            className={classNames("collapse-arrow-column", {
        ...
        {columns.map(
          ({ arrayRenderer, dataClassName, disabled, key, renderer }) => {
            const hide =
              groupRow &&
              get(grouping, "columnsToHide", []).indexOf(key) !== -1;
