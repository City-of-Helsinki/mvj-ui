...
export const normalizeInteger = (value: any): any =>
  (value && Number.isInteger(Number(value))) ? Number(value) : value;

export const genericNormalizer = (value: any, options: Object): any => {
  if (!options) {
    return value;
  }
