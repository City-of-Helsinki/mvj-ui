...
import {
  fetchPlanUnitListWithIdentifiersList,
  fetchCustomDetailedPlanListWithIdentifiersList,
} from "@/plotSearch/requestsAsync";
type Props = {
  disabled?: boolean;
  name: string;
...
const PlanUnitSelectInput = ({
  ...
  const getPlanUnitOptions = (
    planUnitList: Array<Record<string, any>>,
    customDetailedPlanList: Array<Record<string, any>>,
  ...
  return (
    <AsyncSelect
      ...
      getOptions={(inputValue, callBack) =>
        getPlanUnitList(inputValue, callBack)
      }
      input={input}
      isDirty={false}
