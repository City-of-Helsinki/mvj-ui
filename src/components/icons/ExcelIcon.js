...
const ExcelIcon = ({className}: Props) =>
  <svg className={classNames('icons', 'icons__excel-icon', className)} focusable='false' viewBox="0 0 15 12">
    <g stroke='none' transform="scale(0.3,0.3) translate(0,3)">
