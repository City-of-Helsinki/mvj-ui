...
function InfillDevelopmentPageAttributes(WrappedComponent: any) {
  ...
  return class InfillDevelopmentPageAttributes extends PureComponent<Props, State> {
    ...
    componentDidUpdate(prevProps: Props) {
      if (this.props.isFetchingInfillDevelopmentAttributes !== prevProps.isFetchingInfillDevelopmentAttributes || this.props.isFetchingInfillDevelopmentAttachmentAttributes !== prevProps.isFetchingInfillDevelopmentAttachmentAttributes || this.props.isFetchingLeaseAttributes !== prevProps.isFetchingLeaseAttributes) {
    ...
    setIsFetchingAttributes = () => {
      ...
      const isFetching = isFetchingInfillDevelopmentAttributes || isFetchingInfillDevelopmentAttachmentAttributes || isFetchingLeaseAttributes;
      this.setState({
