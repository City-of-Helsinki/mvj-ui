...
function BatchrunJobRunTabAttributes(WrappedComponent: any) {
  type Props = {
    ...
    fetchBatchrunJobRunAttributes: Function,
    fetchBatchrunJobRunLogEntryAttributes: Function,
  ...
  return class BatchrunJobRunTabAttributes extends PureComponent<Props, State> {
    ...
    componentDidUpdate(prevProps: Props) {
      if(this.props.isFetchingBatchrunJobRunAttributes !== prevProps.isFetchingBatchrunJobRunAttributes ||
        this.props.isFetchingBatchrunJobRunLogEntryAttributes !== prevProps.isFetchingBatchrunJobRunLogEntryAttributes) {
    ...
    setIsFetchingAttributes = () => {
      ...
      const isFetching = isFetchingBatchrunJobRunAttributes ||
        isFetchingBatchrunJobRunLogEntryAttributes;

      this.setState({isFetchingAttributes: isFetching});
    }
