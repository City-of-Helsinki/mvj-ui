...
function LandUseContractInvoiceAttributes(WrappedComponent: any) {
  type Props = {
...
const withLandUseContractInvoiceAttributes = flowRight(
  connect(
    (state) => {
      return{
  ...
  LandUseContractInvoiceAttributes,
);

export {withLandUseContractInvoiceAttributes};
