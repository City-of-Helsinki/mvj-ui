          ...
          width: width
              ...
              {!isFetchingUsersPermissions && <ul hidden={!isOpen && !isClosing && !isOpening}>
                ...
                color: '#b7b7b7'
                  ...
                  {!import.meta.env.PROD && <SubMenu header='Tonttihaut ja kilpailut' isOpen={subMenuKey === 'plot'} items={[{
              ...
              to: getRouteById(Routes.PLOT_APPLICATIONS)
                  ...
                  {!import.meta.env.PROD && <Authorization allow={hasPermissions(usersPermissions, UsersPermissions.VIEW_AREASEARCH)}>
