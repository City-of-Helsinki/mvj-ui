...
class SideMenu extends Component<Props, State> {
  ...
  render() {
    const { isFetchingUsersPermissions, isOpen, usersPermissions } = this.props;
                ...
                <ul hidden={!isOpen && !isClosing && !isOpening}>
                  ...
                  >
                    <li>
                      <Link
                        onClick={handleClick}
                        to={getRouteById(Routes.CONTACTS)}
                      >
                        Asiakkaat
                      </Link>
                    </li>
                  ...
                  <Authorization
                    allow={hasPermissions(
                      usersPermissions,
                      UsersPermissions.VIEW_AREANOTE,
                    )}
                  >
                    <li>
                      <Link
                        onClick={handleClick}
                        to={getRouteById(Routes.AREA_NOTES)}
                      >
                        Muistettavat ehdot
                      </Link>
                    </li>
                  ...
                  >
                    <li>
                      <Link
                        onClick={handleClick}
                        to={getRouteById(Routes.RENT_BASIS)}
                      >
                        Vuokrausperiaatteet
                      </Link>
                    </li>
                  ...
                  >
                    <li>
                      <Link
                        ...
                        onClick={handleClick}
                        to={getRouteById(Routes.INFILL_DEVELOPMENTS)}
                      >
                  ...
                  <Authorization
                    allow={
                      ...
                      hasPermissions(
                        usersPermissions,
                        UsersPermissions.VIEW_INDEX,
                      ) ||
                      hasPermissions(
                        usersPermissions,
                        UsersPermissions.VIEW_JOBRUN,
                      ) ||
                      hasPermissions(
                        usersPermissions,
                        UsersPermissions.VIEW_SCHEDULEDJOB,
                      ) ||
                      hasPermissions(
                        usersPermissions,
                      ...
                      hasPermissions(
                        usersPermissions,
                        UsersPermissions.VIEW_LEASEHOLDTRANSFER,
                      )
                    }
                  >
                    <SubMenu
