...
const paattajaOptions = [
  ...
  { label: "Asuntotontit tiimipäällikkö", value: "Asuntotontit tiimipäällikkö" },
];
...
const paatoksenTyyppiOptions = [
  ...
  { label: "Maankäyttösopimuksen hyväksyntä", value: "Maankäyttösopimuksen hyväksyntä" },
];
...
const defaultDecisions: DecisionItem[] = [
  {
    title: "Asuntotontit tiimipäällikkö 11.2025 60 § Rasite- ja/tai rasitteenluont.ehdon lis. (1 ehto)",
...
const defaultAgreements: AgreementItem[] = [
  {
    ...
    toinenKutsuLahetetty: "-",
    kolmasKutsuLahetetty: "-",
    paatos: "Asuntotontit tiimipäällikkö 11.2025 60 § Rasite- ja/tai rasitteenluont.ehdon lis. (1 ehto)",
    muutokset: [
      {
        allekirjoituspvm: "1.1.2025",
        allekirjoitettavaMennessa: "-",
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <h3 className="landuse-detail__subsection-title">Ehdot</h3>
                            ...
                            <Field name={`${conditionName}.valvontapvm`}>
                              {({ input }) => (
                                <DateInput
                                  ...
                                  label="Valvontapvm"
                                  value={input.value ?? conditions[conditionIndex].valvontapvm}
                                  onChange={input.onChange}
                                  placeholder="DD.MM.YYYY"
                                  disabled={!isEditMode}
                                />
                            ...
                            <Field name={`${conditionName}.valvottuPvm`}>
                              {({ input }) => (
                                <DateInput
                                  ...
                                  label="Valvottu pvm"
                                  value={input.value ?? conditions[conditionIndex].valvottuPvm}
                                  onChange={input.onChange}
                                  placeholder="DD.MM.YYYY"
                                  disabled={!isEditMode}
                                />
                            ...
                            <Field name={`${conditionName}.note`}>
                              {({ input }) => (
                                <TextInput
                                  ...
                                  label="Huomautus"
                                  value={input.value ?? conditions[conditionIndex].note}
                                  onChange={input.onChange}
                                  disabled={!isEditMode}
                                  placeholder="Placeholder"
                                />
                ...
                >
                  ...
                  >
                    <div className="landuse-detail__grid landuse-detail__decisions-grid">
                        ...
                        <Field name={`${agreementName}.allekirjoituspvm`}>
                          {({ input }) => (
                            <DateInput
                              ...
                              value={input.value ?? agreement.allekirjoituspvm}
                              onChange={input.onChange}
                              placeholder="DD.MM.YYYY"
                              disabled={!isEditMode}
                            />
                      ...
                      <div className="landuse-detail__column">
                        <Field name={`${agreementName}.allekirjoitettavaMennessa`}>
                          {({ input }) => (
                            <DateInput
                              id={`agreement-allekirjoitettava-mennessa-${agreementIndex}`}
                              label="Allekirjoitettava mennessä"
                              value={
                                input.value ?? agreement.allekirjoitettavaMennessa
                              }
                              onChange={input.onChange}
                              placeholder="DD.MM.YYYY"
                              disabled={!isEditMode}
                      ...
                      <div className="landuse-detail__column">
                        <Field name={`${agreementName}.ensimmainenKutsuLahetetty`}>
                          {({ input }) => (
                            <DateInput
                              id={`agreement-1-kutsu-${agreementIndex}`}
                              label="1. kutsu lähetetty"
                              value={
                                input.value ?? agreement.ensimmainenKutsuLahetetty
                              }
                              onChange={input.onChange}
                              placeholder="DD.MM.YYYY"
                              disabled={!isEditMode}
                        ...
                        <Field name={`${agreementName}.toinenKutsuLahetetty`}>
                          {({ input }) => (
                            <DateInput
                              ...
                              value={input.value ?? agreement.toinenKutsuLahetetty}
                              onChange={input.onChange}
                              placeholder="DD.MM.YYYY"
                              disabled={!isEditMode}
                            />
                        ...
                        <Field name={`${agreementName}.kolmasKutsuLahetetty`}>
                          {({ input }) => (
                            <DateInput
                              ...
                              value={input.value ?? agreement.kolmasKutsuLahetetty}
                              onChange={input.onChange}
                              placeholder="DD.MM.YYYY"
                              disabled={!isEditMode}
                            />
                            ...
                            <Select
                              ...
                              value={
                                input.value
                                  ...
                                  : agreement.paatos
                                    ? [{ label: agreement.paatos, value: agreement.paatos }]
                                    : []
                              }
                              onChange={(selected) =>
                                handleSelectChange(selected, input.onChange)
                    ...
                    {(agreement.muutokset?.length
                      ...
                      return (
                        ...
                        >
                            ...
                            <Field name={`${changeName}.allekirjoituspvm`}>
                              {({ input }) => (
                                <DateInput
                                  ...
                                  value={
                                    input.value ??
                                    agreement.muutokset[changeIndex]?.allekirjoituspvm ??
                                    ""
                                  }
                                  onChange={input.onChange}
                                  placeholder="DD.MM.YYYY"
                          ...
                          <div className="landuse-detail__column">
                            <Field name={`${changeName}.allekirjoitettavaMennessa`}>
                              {({ input }) => (
                                <DateInput
                                  ...
                                  value={
                                    input.value ??
                                    agreement.muutokset[changeIndex]?.allekirjoitettavaMennessa ??
                                    ""
                                  }
                                  onChange={input.onChange}
                                  placeholder="DD.MM.YYYY"
                          ...
                          <div className="landuse-detail__column">
                            <Field name={`${changeName}.ensimmainenKutsuLahetetty`}>
                              {({ input }) => (
                                <DateInput
                                  ...
                                  value={
                                    input.value ??
                                    agreement.muutokset[changeIndex]?.ensimmainenKutsuLahetetty ??
                                    ""
                                  }
                                  onChange={input.onChange}
                                  placeholder="DD.MM.YYYY"
                          ...
                          <div className="landuse-detail__column">
                            <Field name={`${changeName}.toinenKutsuLahetetty`}>
                              {({ input }) => (
                                <DateInput
                                  ...
                                  value={
                                    input.value ??
                                    agreement.muutokset[changeIndex]?.toinenKutsuLahetetty ??
                                    ""
                                  }
                                  onChange={input.onChange}
                                  placeholder="DD.MM.YYYY"
                          ...
                          <div className="landuse-detail__column">
                            <Field name={`${changeName}.kolmasKutsuLahetetty`}>
                              {({ input }) => (
                                <DateInput
                                  ...
                                  value={
                                    input.value ??
                                    agreement.muutokset[changeIndex]?.kolmasKutsuLahetetty ??
                                    ""
                                  }
                                  onChange={input.onChange}
                                  placeholder="DD.MM.YYYY"
                            ...
                            <Field name={`${changeName}.paatos`}>
                              {({ input }) => (
                                <TextInput
                                  ...
                                  value={
                                    input.value ??
                                    agreement.muutokset[changeIndex]?.paatos ??
                                    ""
                                  }
                                  onChange={input.onChange}
                                  disabled={!isEditMode}
                            ...
                            <Field name={`${changeName}.huomautus`}>
                              {({ input }) => (
                                <TextInput
                                  ...
                                  value={
                                    input.value ??
                                    agreement.muutokset[changeIndex]?.huomautus ??
                                    ""
                                  }
                                  onChange={input.onChange}
                                  disabled={!isEditMode}
                    ...
                    <h3 className="landuse-detail__subsection-title">Vakuudet</h3>
                    ...
                    {agreement.vakuudet.map((_, vakuusIndex) => {
                      ...
                      const usageRows = agreement.vakuudet[vakuusIndex].siteUsages.map(
                        (row, rowIndex) => ({
                          id: `${agreementIndex}-${vakuusIndex}-${rowIndex}`,
                          kohde: row.kohde,
                          hallintamuoto: row.hallintamuoto,
                          vakuuttaKaytettyEuro: row.vakuuttaKaytettyEuro,
                          vakuuttaKaytettyProsentti: row.vakuuttaKaytettyProsentti,
                        }),
                      );
                      ...
                      return (
                        ...
                        >
                          <div className="landuse-detail__grid landuse-detail__decisions-grid">
                              ...
                              <Field name={`${vakuusName}.jarjestysnumero`}>
                                {({ input }) => (
                                  <TextInput
                                    ...
                                    value={
                                      input.value ??
                                      agreement.vakuudet[vakuusIndex].jarjestysnumero
                                    }
                                    onChange={input.onChange}
                                    disabled={!isEditMode}
                                  />
                              ...
                              <Field name={`${vakuusName}.tyyppi`}>
                                {({ input }) => (
                                  <Select
                                    ...
                                    texts={{ label: "Vakuuden tyyppi", placeholder: "Valitse" }}
                                    options={vakuudenTyyppiOptions}
                                    value={
                                      input.value
                                        ? [{ label: input.value, value: input.value }]
                                        : agreement.vakuudet[vakuusIndex].tyyppi
                                          ? [
                                              {
                                                label:
                                                  agreement.vakuudet[vakuusIndex].tyyppi ??
                              ...
                              <Field name={`${vakuusName}.laji`}>
                                {({ input }) => (
                                  <Select
                                    ...
                                    texts={{ label: "Vakuuden laji", placeholder: "Valitse" }}
                              ...
                              <Field name={`${vakuusName}.vakuusnumero`}>
                                {({ input }) => (
                                  <TextInput
                                    ...
                                    value={
                                      input.value ??
                                      agreement.vakuudet[vakuusIndex].vakuusnumero
                                    }
                                    onChange={input.onChange}
                                    disabled={!isEditMode}
                                  />
                              ...
                              <Field name={`${vakuusName}.alkupvm`}>
                                {({ input }) => (
                                  <DateInput
                                    ...
                                    value={input.value ?? agreement.vakuudet[vakuusIndex].alkupvm}
                                    onChange={input.onChange}
                                    placeholder="DD.MM.YYYY"
                                    disabled={!isEditMode}
                                  />
                              ...
                              <Field name={`${vakuusName}.loppupvm`}>
                                {({ input }) => (
                                  <DateInput
                                    ...
                                    value={
                                      input.value ?? agreement.vakuudet[vakuusIndex].loppupvm
                                    }
                                    onChange={input.onChange}
                                    placeholder="DD.MM.YYYY"
                                    disabled={!isEditMode}
                              ...
                              <Field name={`${vakuusName}.palautettuPvm`}>
                                {({ input }) => (
                                  <DateInput
                                    ...
                                    value={
                                      input.value ??
                                      agreement.vakuudet[vakuusIndex].palautettuPvm
                                    }
                                    onChange={input.onChange}
                                    placeholder="DD.MM.YYYY"
                                    disabled={!isEditMode}
                              ...
                              <Field name={`${vakuusName}.huomautus`}>
                                {({ input }) => (
                                  <TextInput
                                    ...
                                    label="Huomautus"
                                    value={
                                      input.value ?? agreement.vakuudet[vakuusIndex].huomautus
                                    }
                                    onChange={input.onChange}
                                    disabled={!isEditMode}
                                    placeholder="Placeholder"
                            ...
                            <div className="landuse-detail__column">
                              <Field name={`${vakuusName}.panttikirjanNumero`}>
                                {({ input }) => (
                                  <TextInput
                                    ...
                                    value={
                                      input.value ??
                                      agreement.vakuudet[vakuusIndex].panttikirjanNumero
                                    }
                                    onChange={input.onChange}
                                    disabled={!isEditMode}
                                  />
                              ...
                              <Field name={`${vakuusName}.vakuudenMaara`}>
                                {({ input }) => (
                                  <TextInput
                                    ...
                                    value={
                                      input.value ?? agreement.vakuudet[vakuusIndex].vakuudenMaara
                                    }
                                    onChange={input.onChange}
                                    disabled={!isEditMode}
                                  />
                              ...
                              <Field name={`${vakuusName}.vakuuttaKaytetty`}>
                                {({ input }) => (
                                  <TextInput
                                    ...
                                    value={
                                      input.value ??
                                      agreement.vakuudet[vakuusIndex].vakuuttaKaytetty
                                    }
                                    onChange={input.onChange}
                                    disabled={!isEditMode}
                                  />
                              ...
                              <Field name={`${vakuusName}.vakuuttaJaljella`}>
                                {({ input }) => (
                                  <TextInput
                                    ...
                                    value={
                                      input.value ??
                                      agreement.vakuudet[vakuusIndex].vakuuttaJaljella
                                    }
                                    onChange={input.onChange}
                                    disabled={!isEditMode}
                                  />
