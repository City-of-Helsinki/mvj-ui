  ...
  return (
    <Form<LandUseMonitoringFormValues>
      ...
      render={({ handleSubmit, values }) => {
        const toteutunutBySiteId = values.toteutunutBySiteId ?? {};
                  ...
                  <table className="landuse-detail__sites-table landuse-detail__monitoring-table">
                    ...
                    <tbody>
                      {leafSites.map((site, index) => {
                        const toteutunut = toteutunutBySiteId[site.id] ?? "Ei";
                        const isToteutunut = toteutunut === "Kyllä";
                        const yksikkohinta =
                        ...
                        return (
                          <tr key={`perustaulukko-row-${site.id}-${index}`}>
                            ...
                            <td>-</td>
                            <td>
                              <Field name={`toteutunutBySiteId.${site.id}`}>
                                {({ input }) => (
                                  <div className="landuse-detail__monitoring-toteutunut-cell">
                                    <span>{input.value ?? toteutunut}</span>
                                    <Button
                                      type="button"
                                      variant={ButtonVariant.Supplementary}
                                      iconStart={<IconPen />}
                                      ...
                                      onClick={() => {
                                        input.onChange(
                                          isToteutunut ? "Ei" : "Kyllä",
                                        );
                                      }}
                                    >
                                      {isToteutunut
                                        ? "Merkitse ei toteutuneeksi"
                    ...
                    <tbody>
                      {vakuuslaskuriRows.map((row, index) => (
                        ...
                        >
                          ...
                          <td>
                            <Field name={`vakuuslaskuriRows.${index}.hintaero`}>
                              {({ input }) => (
                                <TextInput
                          ...
                          <td>
                            <Field name={`vakuuslaskuriRows.${index}.kerroin`}>
                              {({ input }) => (
                                <Select
                          ...
                          <td>
                            <Field name={`vakuuslaskuriRows.${index}.vakuudet`}>
                              {({ input }) => (
                                <TextInput
