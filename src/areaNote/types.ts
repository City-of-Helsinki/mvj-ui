...
export type FetchAreaNoteListAction = Action<"mvj/areaNote/FETCH_ALL", Record<string, any> | null | undefined>;
...
export type InitializeAction = Action<"mvj/areaNote/INITIALIZE", Record<string, any>>;