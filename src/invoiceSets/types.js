...
export type InvoiceSetsState = Object;

export type InvoiceSetList = Array<Object>;
export type InvoiceSetListMap = Object;

export type FetchInvoiceSetsByLeaseAction = Action<'mvj/invoiceSets/FETCH_BY_LEASE', LeaseId>;
export type ReceiveInvoiceSetsByLeaseAction = Action<'mvj/invoiceSets/RECEIVE_BY_LEASE', InvoiceSetListMap>;
