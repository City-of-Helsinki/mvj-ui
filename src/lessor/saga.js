...
function* fetchLessorsSaga({payload: params}): Generator<any, any, any> {
  try {
    const {response: {status: statusCode}, bodyAsJson} = yield call(fetchContacts, {...params, is_lessor: true});
