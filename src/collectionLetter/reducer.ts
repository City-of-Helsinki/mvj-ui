...
import type { ReceiveAttributesAction, ReceiveMethodsAction, FetchCollectionLettersByLeaseAction, ReceiveCollectionLettersByLeaseAction, CollectionLettersNotFoundByLeaseAction } from "./types";
...
const attributesReducer: Reducer<Attributes> = handleActions({
  ['mvj/collectionLetter/RECEIVE_ATTRIBUTES']: (state: Attributes, {
    payload: attributes
...
const methodsReducer: Reducer<Methods> = handleActions({
  ['mvj/collectionLetter/RECEIVE_METHODS']: (state: Methods, {
    payload: methods
...
const isFetchingByLeaseReducer: Reducer<Record<string, any>> = handleActions({
  ['mvj/collectionLetter/FETCH_BY_LEASE']: (state: Record<string, any>, {
    payload: lease
  ...
  ['mvj/collectionLetter/RECEIVE_BY_LEASE']: (state: Record<string, any>, {
    payload: {
      lease
    }
  ...
  ['mvj/collectionLetter/NOT_FOUND_BY_LEASE']: (state: Record<string, any>, {
    payload: lease
