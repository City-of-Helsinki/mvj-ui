...
function* fetchSapInvoicesSaga({payload: query}): Generator<any, any, any> {
  try {
    let {response: {status: statusCode}, bodyAsJson} = yield call(fetchInvoices, {...query, going_to_sap: true});
