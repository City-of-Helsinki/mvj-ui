...
import { fetchAttributes, receiveAttributes, receiveMethods, attributesNotFound, receiveSingleContact, initializeContactForm, receiveContactFormValid, showEditMode, hideEditMode, showContactModal, hideContactModal, receiveContactModalSettings, receiveContacts, fetchContacts, fetchSingleContact, createContact, editContact, createContactOnModal, editContactOnModal, notFound, receiveIsSaveClicked } from "./actions";
  ...
  describe('Reducer', () => {
    describe('contactReducer', () => {
      ...
      it('should update contacts list', () => {
        ...
        const state = contactReducer({}, receiveContacts({
          results: dummyContactsList
        }));
        expect(state).to.deep.equal(newState);
      });
