  ...
  describe('Reducer', () => {
    ...
    describe('auditLogReducer', () => {
      ...
      it('should update isFetchingByContact to true when fetching contact auditlog', () => {
        ...
        const newState = {...defaultState, isFetchingByContact: {
          [dummyContactId]: true,
        }};
      ...
      it('should update isFetchingByLease to true when fetching lease auditlog', () => {
        ...
        const newState = {...defaultState, isFetchingByLease: {
          [dummyLeaseId]: true,
        }};

        const state = auditLogReducer({}, fetchAuditLogByLease({id: dummyLeaseId}));
        expect(state).to.deep.equal(newState);
      });
      ...
      it('should update isFetchingByLease to false by notFoundByLease', () => {
        ...
        let state = auditLogReducer({}, fetchAuditLogByLease({id: dummyLeaseId}));
