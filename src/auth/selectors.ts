...
export const getApiToken: Selector<ApiToken, void> = (state: Record<string, any>): AuthState => state.auth.apiToken[process.env.OPENID_CONNECT_API_TOKEN_KEY || 'https://api.hel.fi/auth/mvj'];
