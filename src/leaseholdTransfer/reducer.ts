...
const attributesReducer: Reducer<Attributes> = handleActions({
  ['mvj/leaseholdTransfer/RECEIVE_ATTRIBUTES']: (state: Attributes, {
    payload: attributes
...
const methodsReducer: Reducer<Methods> = handleActions({
  ['mvj/leaseholdTransfer/RECEIVE_METHODS']: (state: Methods, {
    payload: methods
...
const listReducer: Reducer<LeaseholdTransferList> = handleActions({
  ['mvj/leaseholdTransfer/RECEIVE_ALL']: (state: LeaseholdTransferList, {
    payload: list
