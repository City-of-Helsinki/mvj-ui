...
const attributesReducer: Reducer<Attributes> = handleActions({
  ['mvj/collectionCourtDecision/RECEIVE_ATTRIBUTES']: (state: Attributes, {
    payload: attributes
...
const methodsReducer: Reducer<Methods> = handleActions({
  ['mvj/collectionCourtDecision/RECEIVE_METHODS']: (state: Methods, {
    payload: methods
...
const isFetchingByLeaseReducer: Reducer<Record<string, any>> = handleActions({
  ['mvj/collectionCourtDecision/FETCH_BY_LEASE']: (state: Record<string, any>, {
    payload: lease
  ...
  ['mvj/collectionCourtDecision/RECEIVE_BY_LEASE']: (state: Record<string, any>, {
    payload: {
      lease
    }
  ...
  ['mvj/collectionCourtDecision/NOT_FOUND_BY_LEASE']: (state: Record<string, any>, {
    payload: lease
