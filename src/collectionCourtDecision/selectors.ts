...
export const getAttributes: Selector<Attributes, void> = (
  state: RootState,
): Attributes => state.collectionCourtDecision.attributes;
export const getMethods: Selector<Methods, void> = (
  state: RootState,
): Methods => state.collectionCourtDecision.methods;
...
export const getIsFetchingByLease: Selector<boolean, LeaseId> = (
  state: RootState,
  lease: LeaseId,
): boolean => state.collectionCourtDecision.isFetchingByLease[lease];
