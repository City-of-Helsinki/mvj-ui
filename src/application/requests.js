...
export const createApplicationRequest = (payload: Object): Generator<any, any, any> => {
  return callApi(new Request(createUrl(`answer/`), {method: 'POST', body: JSON.stringify(payload)}));
};

export const editApplicationRequest = (id: number, payload: Object): Generator<any, any, any> => {
