...
import {
  companyIdentifierValidator, emailValidator,
  personalIdentifierValidator,
  validateApplicationForm,
} from '$src/application/formValidation';
  ...
  describe('validators', () => {
    describe('personalIdentifierValidator', () => {
      ...
      it('should not accept a non-string value', () => {
        const error = personalIdentifierValidator({personalIdentifier: '180670-399C'}, 'fail');
    ...
    describe('companyIdentifierValidator', () => {
      ...
      it('should not accept a non-string value', () => {
        const error = companyIdentifierValidator({companyIdentifier: '0346848-5'}, 'fail');
    ...
    describe('validateApplicationForm', () => {
      ...
      it('should not accept a simple form with multiple control values not equaling a 100% ratio in total', () => {
        ...
        expect(get(error, 'formEntries.sections.test[0].fields.hallintaosuus.value'))
          .to.equal('Hallintaosuuksien yhteismäärän on oltava 100%');
        expect(get(error, 'formEntries.sections.test[1].fields.hallintaosuus.value'))
          .to.equal('Hallintaosuuksien yhteismäärän on oltava 100%');
      });
