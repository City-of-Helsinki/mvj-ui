...
export type ReceiveUpdatedTargetInfoCheckItemAction = Action<"mvj/application/RECEIVE_UPDATED_TARGET_INFO_CHECK_ITEM", Record<string, any>>;
export type ReceiveUpdatedApplicantInfoCheckItemAction = Action<"mvj/application/RECEIVE_UPDATED_APPLICANT_INFO_CHECK_ITEM", Record<string, any>>;
export type FetchFormAttributesAction = Action<"mvj/application/FETCH_FORM_ATTRIBUTES", Record<string, any>>;
...
export type ReceiveApplicationRelatedAttachmentsAction = Action<"mvj/application/RECEIVE_ATTACHMENTS", Record<string, any>>;
export type ApplicationRelatedAttachmentsNotFoundAction = Action<"mvj/application/ATTACHMENTS_NOT_FOUND", void>;
export type DeleteUploadAction = Action<"mvj/application/DELETE_UPLOAD", Record<string, any>>;
...
export type ReceivePendingUploadsAction = Action<"mvj/application/RECEIVE_PENDING_UPLOADS", Record<string, any>>;
