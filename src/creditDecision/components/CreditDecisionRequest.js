...
} from '$src/creditDecision/actions';
import {
...
} from '$src/creditDecision/selectors';

type Props = {
  businessId: String,
  contactId: String,
  contactType: String,
  fetchCreditDecisionByBusinessId: Function,
  fetchCreditDecisionByContactId: Function,
  fetchCreditDecisionByNin: Function,
  ...
  connect(
    (state, props: Props) => {
      return {
        ...
        result: props.contactId ? getCreditDecisionByContactId(state, props.contactId) : (
          props.contactType === ContactTypes.BUSINESS && props.businessId ? getCreditDecisionByBusinessId(state, props.businessId) : (
          props.contactType === ContactTypes.PERSON && props.nin && getCreditDecisionByNin(state, props.nin)
        )),
        isFetchingResult: props.contactId ? getIsFetchingCreditDecisionByContactId(state, props.contactId) : (
          props.contactType === ContactTypes.BUSINESS && props.businessId ? getIsFetchingCreditDecisionByBusinessId(state, props.businessId) : (
          props.contactType === ContactTypes.PERSON && props.nin && getIsFetchingCreditDecisionByNin(state, props.nin)
        )),
      };
    },
    {
