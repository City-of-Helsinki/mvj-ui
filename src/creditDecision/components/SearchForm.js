    ...
    <GreenBox>
      <form onSubmit={handleSubmit(handleSearch)}>
        <SearchRow style={{ marginBottom: 15 }}>
          <SearchLabelColumn style={{ width: 130, marginRight: 10 }}>
          ...
          <SearchInputColumn>
            <FormField
              ...
              overrideValues={{
                options: [
                  {value: ContactTypes.BUSINESS, label: CreditDecisionText.BUSINESS_TITLE},
                  {value: ContactTypes.PERSON, label: CreditDecisionText.PERSON_TITLE},
                ],
              }}
            />
          </SearchInputColumn>
        ...
        {formSelectedType && (
          <Fragment>
            ...
            <Button
              ...
              style={{marginLeft: 140, marginBottom: '1em'}}
            />
          </Fragment>
        )}
      </form>
