...
import {createAreaSearchSpecs, receiveFormValidFlags} from '$src/areaSearch/actions';
          ...
          <Authorization allow={true}>
            <Column small={12} medium={4}>
              ...
              <AddFileButton
                ...
                disabled={isPerformingFileOperation || isSubmittingAreaSearchSpecs}
              />
            </Column>
          </Authorization>
        </Row>
...
)(AreaSearchApplicationCreateSpecs): React$ComponentType<OwnProps>);
