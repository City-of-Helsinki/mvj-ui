...
import SearchSubtitleLabel from '$components/search/SearchSubtitleLabel';
...
class Search extends Component<Props, State> {
  ...
  search = () => {
    ...
    let searchParams: Object = formValues || {};
        ...
        <Row>
          <Column small={6}>
            <SearchChangeTypeLink
              onClick={this.toggleSearchType}>{isBasicSearch ? 'Tarkennettu haku' : 'Yksinkertainen haku'}</SearchChangeTypeLink>
          </Column>
          <Column small={6}>
