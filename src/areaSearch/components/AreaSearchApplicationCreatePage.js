...
type Props = {
  ...
  receiveSingleAreaSearch: Function,
  currentAreaSearch: Object | null,
  fetchFormAttributes: Function,
  formAttributes: Attributes,
  isFetchingFormAttributes: boolean,
  specsFormValues: Object,
  ...
  createAreaSearchSpecs: Function,
  createAreaSearchApplication: Function,
  receiveIsSaveClicked: Function,
  isPerformingFileOperation: boolean,
  isSaveClicked: boolean,
  uploadAttachment: Function,
  deleteUploadedAttachment: Function,
      ...
      <FullWidthContainer>
          ...
          <ControlButtonBar
            buttonComponent={
              <ControlButtons
                ...
                isEditDisabled={true}
                isEditMode={true}
                isSaveDisabled={isSubmitting || isPerformingFileOperation || isSaveClicked && !areFormsValid}
                onCancel={this.handleBack}
                onSave={!currentAreaSearch ? this.submitSearchPart : this.saveChanges}
                showCommentButton={false}
                showCopyButton={false}
                saveButtonText={!currentAreaSearch ? 'Jatka lomakkeen täyttöön' : 'Tallenna'}
              />
            }
            infoComponent={<h1>
              Uusi aluehakemus
        ...
        <PageContainer className='with-control-bar-and-tabs' hasTabs>
          <TabContent active={activeTab}>
            <TabPane>
              <ContentContainer>
                {initialized && <AreaSearchApplicationCreateSpecs
            ...
            <TabPane>
              <ContentContainer>
                {currentAreaSearch && <AreaSearchApplicationCreateForm
...
)(AreaSearchApplicationCreatePage): React$ComponentType<OwnProps>);
