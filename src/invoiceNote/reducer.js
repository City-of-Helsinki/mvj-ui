...
const attributesReducer: Reducer<Attributes> = handleActions({
  ['mvj/invoiceNote/RECEIVE_ATTRIBUTES']: (state: Attributes, {payload: attributes}: ReceiveAttributesAction) => {
    return attributes;
  },
}, null);

const methodsReducer: Reducer<Methods> = handleActions({
  ['mvj/invoiceNote/RECEIVE_METHODS']: (state: Methods, {payload: methods}: ReceiveMethodsAction) => {
    return methods;
  },
}, null);
...
const listReducer: Reducer<InvoiceNoteList> = handleActions({
  ['mvj/invoiceNote/RECEIVE_ALL']: (state: InvoiceNoteList, {payload: invoiceNotes}: ReceiveInvoiceNoteListAction) => {
    return invoiceNotes;
  },
}, {});
