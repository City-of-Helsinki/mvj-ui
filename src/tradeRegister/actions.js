...
export const fetchTradeRegisterCompanyNoticeById = (businessId: string): FetchTradeRegisterCompanyNoticeByIdAction =>
  createAction('mvj/tradeRegister/FETCH_COMPANY_NOTICE_BY_ID')(businessId);

export const receiveTradeRegisterCompanyNoticeById = (payload: TradeRegisterDataMap): ReceiveTradeRegisterCompanyNoticeByIdAction =>
  createAction('mvj/tradeRegister/RECEIVE_COMPANY_NOTICE_BY_ID')(payload);

export const companyNoticeNotFoundById = (businessId: string): CompanyNoticeNotFoundByIdAction =>
  createAction('mvj/tradeRegister/COMPANY_NOTICE_NOT_FOUND_BY_ID')(businessId);

export const fetchTradeRegisterCompanyRepresentById = (businessId: string): FetchTradeRegisterCompanyRepresentByIdAction =>
  createAction('mvj/tradeRegister/FETCH_COMPANY_REPRESENT_BY_ID')(businessId);

export const receiveTradeRegisterCompanyRepresentById = (payload: TradeRegisterDataMap): ReceiveTradeRegisterCompanyRepresentByIdAction =>
  createAction('mvj/tradeRegister/RECEIVE_COMPANY_REPRESENT_BY_ID')(payload);

export const companyRepresentNotFoundById = (businessId: string): CompanyRepresentNotFoundByIdAction =>
  createAction('mvj/tradeRegister/COMPANY_REPRESENT_NOT_FOUND_BY_ID')(businessId);
