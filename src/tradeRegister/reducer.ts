...
const isFetchingCompanyExtendedByIdReducer: Reducer<TradeRegisterIsFetchingMap> =
  handleActions(
    {
      ["mvj/tradeRegister/FETCH_COMPANY_EXTENDED_BY_ID"]: (
        state: TradeRegisterIsFetchingMap,
        { payload: businessId }: FetchTradeRegisterCompanyExtendedByIdAction,
      ) => ({ ...state, [businessId]: true }),
      ["mvj/tradeRegister/RECEIVE_COMPANY_EXTENDED_BY_ID"]: (
        state: TradeRegisterIsFetchingMap,
        { payload }: ReceiveTradeRegisterCompanyExtendedByIdAction,
      ): any => ({
        ...state,
      ...
      ["mvj/tradeRegister/COMPANY_EXTENDED_NOT_FOUND_BY_ID"]: (
        state: TradeRegisterIsFetchingMap,
        { payload: businessId }: CompanyExtendedNotFoundByIdAction,
      ) => ({ ...state, [businessId]: false }),
    },
    {},
  );
const companyExtendedByIdReducer: Reducer<TradeRegisterDataMap> = handleActions(
  {
    ["mvj/tradeRegister/RECEIVE_COMPANY_EXTENDED_BY_ID"]: (
      state: TradeRegisterDataMap,
      { payload }: ReceiveTradeRegisterCompanyExtendedByIdAction,
    ) => ({ ...state, ...payload }),
  },
  {},
);
const isFetchingCompanyNoticeByIdReducer: Reducer<TradeRegisterIsFetchingMap> =
  handleActions(
    {
      ["mvj/tradeRegister/FETCH_COMPANY_NOTICE_BY_ID"]: (
        state: TradeRegisterIsFetchingMap,
        { payload: businessId }: FetchTradeRegisterCompanyNoticeByIdAction,
      ) => ({ ...state, [businessId]: true }),
      ...
      ["mvj/tradeRegister/COMPANY_NOTICE_NOT_FOUND_BY_ID"]: (
        state: TradeRegisterIsFetchingMap,
        { payload: businessId }: CompanyNoticeNotFoundByIdAction,
      ) => ({ ...state, [businessId]: false }),
    },
    {},
  );
...
const isFetchingCompanyRepresentByIdReducer: Reducer<TradeRegisterIsFetchingMap> =
  handleActions(
    {
      ["mvj/tradeRegister/FETCH_COMPANY_REPRESENT_BY_ID"]: (
        state: TradeRegisterIsFetchingMap,
        { payload: businessId }: FetchTradeRegisterCompanyRepresentByIdAction,
      ) => ({ ...state, [businessId]: true }),
      ["mvj/tradeRegister/RECEIVE_COMPANY_REPRESENT_BY_ID"]: (
        state: TradeRegisterIsFetchingMap,
        { payload }: ReceiveTradeRegisterCompanyRepresentByIdAction,
      ): any => ({
        ...state,
        ...Object.keys(payload).reduce(
          (obj, key) => ({ ...obj, [key]: false }),
      ...
      ["mvj/tradeRegister/COMPANY_REPRESENT_NOT_FOUND_BY_ID"]: (
        state: TradeRegisterIsFetchingMap,
        { payload: businessId }: CompanyRepresentNotFoundByIdAction,
      ) => ({ ...state, [businessId]: false }),
    },
    {},
  );
const companyRepresentByIdReducer: Reducer<TradeRegisterDataMap> =
  handleActions(
    {
      ["mvj/tradeRegister/RECEIVE_COMPANY_REPRESENT_BY_ID"]: (
        state: TradeRegisterDataMap,
...
const collapseStatesReducer: Reducer<Record<string, any>> = handleActions(
  {
    ["mvj/tradeRegister/RECEIVE_COLLAPSE_STATES"]: (
