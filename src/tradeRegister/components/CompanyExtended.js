            ...
            <Fragment>
              <Row>
                ...
                <Column small={12} medium={8} large={6}>
                  ...
                  <ShowMore
                    className='no-margin'
                    text={get(companyExtended, CompanyExtendedFieldPaths.LINE_OF_BUSINESS) || '-'}
                  />
                </Column>
                <Column small={12} medium={4} large={2}>
              ...
              <Collapse
                ...
                defaultOpen={companyNameCollapseState !== undefined ? companyNameCollapseState : false}
                headerTitle={CompanyExtendedFieldTitles.COMPANY_NAME}
                onToggle={handleCollapseToggleCompanyName}
                enableUiDataEdit
                uiDataKey={getUiDataTradeRegisterCompanyExtendedKey(CompanyExtendedFieldPaths.COMPANY_NAME)}
              >
              ...
              <Collapse
                className='collapse__secondary'
                defaultOpen={contactInformationCollapseState !== undefined ? contactInformationCollapseState :false}
              ...
              >
                <Row>
                  <Column small={12} medium={4} large={2}>
                    ...
                    {get(companyExtended, CompanyExtendedFieldPaths.CONTACT_INFORMATION_HOMEPAGE)
                      ? <ExternalLink href={get(companyExtended, CompanyExtendedFieldPaths.CONTACT_INFORMATION_HOMEPAGE)} text={get(companyExtended, CompanyExtendedFieldPaths.CONTACT_INFORMATION_HOMEPAGE)} />
                      : <FormText>-</FormText>
                    }
                  </Column>
                  <Column small={12} medium={4} large={2}>
