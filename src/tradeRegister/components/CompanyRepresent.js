...
type Props = {
  ...
  companyRepresentCollapseState: ?boolean,
  companyRepresentBodyCollapseState: ?boolean,
  companyRepresentLegalRepresentationCollapseState: ?boolean,
  companyRepresentRepresentationCollapseState: ?boolean,
...
const CompanyRepresent = ({
  ...
  return (
    <Collapse
      defaultOpen={companyRepresentCollapseState !== undefined ? companyRepresentCollapseState : false}
      headerTitle={CompanyRepresentFieldTitles.REPRESENT_TITLE}
      onToggle={handleCollapseToggleCompanyRepresent}
      enableUiDataEdit
      uiDataKey={getUiDataTradeRegisterCompanyRepresentKey(CompanyRepresentFieldPaths.REPRESENT_TITLE)}
    >
      {isFetchingCompanyRepresent &&
        <LoaderWrapper>
          ...
          {!!companyRepresent &&
            <Fragment>
              <Collapse
                ...
                defaultOpen={companyRepresentBodyCollapseState !== undefined ? companyRepresentBodyCollapseState : true}
                headerTitle={CompanyRepresentFieldTitles.BODY}
                onToggle={handleCollapseToggleCompanyRepresentBody}
                enableUiDataEdit
                uiDataKey={getUiDataTradeRegisterCompanyRepresentKey(CompanyRepresentFieldPaths.BODY)}
              >
              ...
              <Collapse
                className='collapse__secondary'
                defaultOpen={companyRepresentRepresentationCollapseState !== undefined ? companyRepresentRepresentationCollapseState : true}
                headerTitle={CompanyRepresentFieldTitles.REPRESENTATION}
                onToggle={handleCollapseToggleCompanyRepresentRepresentation}
                enableUiDataEdit
                uiDataKey={getUiDataTradeRegisterCompanyRepresentKey(CompanyRepresentFieldPaths.REPRESENTATION)}
              >
              ...
              <Collapse
                className='collapse__secondary'
                defaultOpen={companyRepresentLegalRepresentationCollapseState !== undefined ? companyRepresentLegalRepresentationCollapseState : true}
                headerTitle={CompanyRepresentFieldTitles.LEGAL_REPRESENTATION}
                onToggle={handleCollapseToggleCompanyRepresentLegalRepresentation}
                enableUiDataEdit
                uiDataKey={getUiDataTradeRegisterCompanyRepresentKey(CompanyRepresentFieldPaths.REPRESENTATION)}
              >
