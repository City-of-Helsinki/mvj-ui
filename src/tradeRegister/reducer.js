...
const isFetchingCompanyExtendedByIdReducer: Reducer<TradeRegisterIsFetchingMap> = handleActions({
  ['mvj/tradeRegister/FETCH_COMPANY_EXTENDED_BY_ID']: (state:TradeRegisterIsFetchingMap, {payload: businessId}: FetchTradeRegisterCompanyExtendedByIdAction) => ({
    ...state,
    [businessId]: true,
  }),
...
const isFetchingCompanyNoticeByIdReducer: Reducer<TradeRegisterIsFetchingMap> = handleActions({
  ['mvj/tradeRegister/FETCH_COMPANY_NOTICE_BY_ID']: (state:TradeRegisterIsFetchingMap, {payload: businessId}: FetchTradeRegisterCompanyNoticeByIdAction) => ({
    ...state,
    [businessId]: true,
  }),
  ['mvj/tradeRegister/RECEIVE_COMPANY_NOTICE_BY_ID']: (state: TradeRegisterIsFetchingMap, {payload}: ReceiveTradeRegisterCompanyNoticeByIdAction) => ({
    ...state,
    ...Object.keys(payload).reduce((obj, key) => ({...obj, [key]: false}), {}),
  }),
  ['mvj/tradeRegister/COMPANY_NOTICE_NOT_FOUND_BY_ID']: (state: TradeRegisterIsFetchingMap, {payload: businessId}: CompanyNoticeNotFoundByIdAction) => ({
    ...state,
    [businessId]: false,
  }),
}, {});
...
const companyNoticeByIdReducer: Reducer<TradeRegisterDataMap> = handleActions({
  ['mvj/tradeRegister/RECEIVE_COMPANY_NOTICE_BY_ID']: (state: TradeRegisterDataMap, {payload}: ReceiveTradeRegisterCompanyNoticeByIdAction) => ({
    ...state,
    ...payload,
  }),
}, {});
...
const isFetchingCompanyRepresentByIdReducer: Reducer<TradeRegisterIsFetchingMap> = handleActions({
  ['mvj/tradeRegister/FETCH_COMPANY_REPRESENT_BY_ID']: (state:TradeRegisterIsFetchingMap, {payload: businessId}: FetchTradeRegisterCompanyRepresentByIdAction) => ({
    ...state,
    [businessId]: true,
  }),
  ['mvj/tradeRegister/RECEIVE_COMPANY_REPRESENT_BY_ID']: (state: TradeRegisterIsFetchingMap, {payload}: ReceiveTradeRegisterCompanyRepresentByIdAction) => ({
    ...state,
    ...Object.keys(payload).reduce((obj, key) => ({...obj, [key]: false}), {}),
  }),
  ['mvj/tradeRegister/COMPANY_REPRESENT_NOT_FOUND_BY_ID']: (state: TradeRegisterIsFetchingMap, {payload: businessId}: CompanyRepresentNotFoundByIdAction) => ({
    ...state,
    [businessId]: false,
  }),
}, {});
...
const companyRepresentByIdReducer: Reducer<TradeRegisterDataMap> = handleActions({
  ['mvj/tradeRegister/RECEIVE_COMPANY_REPRESENT_BY_ID']: (state: TradeRegisterDataMap, {payload}: ReceiveTradeRegisterCompanyRepresentByIdAction) => ({
    ...state,
    ...payload,
  }),
}, {});
