...
export const fetchRentForPeriodByLease = (
  payload: FetchRentForPeriodPayload,
): FetchRentForPeriodAction =>
  createAction("mvj/rentforperiod/FETCH_ALL")(payload);
export const receiveRentForPeriodByLease = (
  rent: RentForPeriod,
): ReceiveRentForPeriodByLeaseAction =>
  createAction("mvj/rentforperiod/RECEIVE_BY_LEASE")(rent);
export const deleteRentForPeriodByLease = (
  payload: DeleteRentForPeriodPayload,
): DeleteRentForPeriodByLeaseAction =>
