...
import { getAttributes as getPlotSearchAttributes, getPlotSearchList } from "plotSearch/selectors";
...
import { fetchPlotSearchSubtypes } from "plotApplications/actions";
import { getPlotSearchSubTypes } from "plotApplications/selectors";
type OwnProps = {
...
type State = {
  ...
  plotSearches: PlotSearchList;
  plotSearchOptions: Array<Record<string, any>>;
  plotSearchAttributes: Attributes;
...
class Search extends Component<Props, State> {
  ...
  static getDerivedStateFromProps(props: Props, state: State) {
    ...
    if (props.plotSearches !== state.plotSearches && props.plotSearches.results) {
      newState.plotSearchOptions = props.plotSearches.results.map(result => ({
        label: result.name,
        value: result.id
      }));
    }
            ...
            /* First column */
              ...
              <Column small={12} large={6}>
                <SearchRow>
                  ...
                  read_only: false
                }} invisibleLabel name='plot_search' overrideValues={{
                ...
                <SearchRow>
                  ...
                  type: FieldTypes.CHOICE,
                  read_only: false
                }} name='plot_search_type' overrideValues={{
                  options: typeOptions,
            ...
            /* Second column */
              ...
              <Column small={12} large={6}>
                ...
                <SearchRow>
                  ...
                  type: FieldTypes.CHOICE,
                  read_only: false
                }} name='plot_search_subtype' overrideValues={{
