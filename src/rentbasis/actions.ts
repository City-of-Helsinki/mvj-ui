...
export const fetchRentBasisList = (
  query: Record<string, any> | null | undefined,
): FetchRentBasisListAction => createAction("mvj/rentbasis/FETCH_ALL")(query);
export const receiveRentBasisList = (
  rentbasis: RentBasisList,
): ReceiveRentBasisListAction =>
  createAction("mvj/rentbasis/RECEIVE_ALL")(rentbasis);
export const fetchSingleRentBasis = (
  id: RentBasisId,
): FetchSingleRentBasisAction => createAction("mvj/rentbasis/FETCH_SINGLE")(id);
export const receiveSingleRentBasis = (
  rentbasis: RentBasis,
): ReceiveSingleRentBasisAction =>
