...
const RentBasisReadonly = ({ rentBasis, rentBasisAttributes }: Props) => {
  ...
  const managementOptions = getFieldOptions(
    rentBasisAttributes,
    RentBasisFieldPaths.MANAGEMENT,
  );
  const financingOptions = getFieldOptions(
    rentBasisAttributes,
    RentBasisFieldPaths.FINANCING,
  );
  const indexOptions = getFieldOptions(
    rentBasisAttributes,
  ...
  const areaUnitOptions = getFieldOptions(
    rentBasisAttributes,
        ...
        <Column small={6} medium={4} large={3}>
          ...
          >
            <>
              ...
              <FormText>
                {getLabelOfOption(plotTypeOptions, rentBasis.plot_type) || "-"}
              </FormText>
            </>
          </Authorization>
        </Column>
        ...
        <Column small={6} medium={4} large={3}>
          ...
          >
            <>
              ...
              {rentBasis.property_identifiers &&
              !!rentBasis.property_identifiers.length ? (
                <ListItems>
        ...
        <Column small={6} medium={4} large={2}>
          ...
          >
            <>
              ...
              <FormText>
                {getLabelOfOption(managementOptions, rentBasis.management) ||
                  "-"}
              </FormText>
            </>
          </Authorization>
        ...
        <Column small={6} medium={4} large={2}>
          ...
          >
            <>
              ...
              <FormText>
                {getLabelOfOption(financingOptions, rentBasis.financing) || "-"}
              </FormText>
            </>
          </Authorization>
        </Column>
        ...
        <Column small={6} medium={4} large={3}>
          ...
          >
            <>
              ...
              <FormText>
                {formatDate(rentBasis.lease_rights_end_date) || "-"}
              </FormText>
            </>
          </Authorization>
        </Column>
        <Column small={6} medium={4} large={2}>
          ...
          >
            <>
              ...
              <FormText>
                {getLabelOfOption(indexOptions, rentBasis.index) || "-"}
              </FormText>
            </>
          </Authorization>
        </Column>
                    ...
                    <Row key={index}>
                      <Column small={6} medium={4} large={2}>
                        ...
                        >
                          <ListItem>
                            {getLabelOfOption(
                              buildPermissionTypeOptions,
                              price.build_permission_type,
                            ) || "-"}
                          </ListItem>
                        </Authorization>
                      </Column>
