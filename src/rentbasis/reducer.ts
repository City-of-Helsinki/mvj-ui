...
const attributesReducer: Reducer<Attributes> = handleActions(
  {
    ["mvj/rentbasis/RECEIVE_ATTRIBUTES"]: (
      state: Attributes,
...
const rentBasisListReducer: Reducer<RentBasisList> = handleActions(
  {
    ["mvj/rentbasis/RECEIVE_ALL"]: (
      state: RentBasisList,
      { payload: rentbasis }: ReceiveRentBasisListAction,
    ) => {
      return rentbasis;
    },
  },
...
const rentBasisReducer: Reducer<RentBasis> = handleActions(
  {
    ["mvj/rentbasis/RECEIVE_SINGLE"]: (
      state: RentBasis,
      { payload: rentbasis }: ReceiveSingleRentBasisAction,
    ) => {
      return rentbasis;
    },
  },
