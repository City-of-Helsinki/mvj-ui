...
import { receiveAttributes, receiveMethods, fetchAttributes, attributesNotFound, fetchRentBasisList, receiveRentBasisList, fetchSingleRentBasis, receiveSingleRentBasis, createRentBasis, editRentBasis, notFound, initializeRentBasis, showEditMode, hideEditMode, receiveFormValid, receiveIsSaveClicked } from "./actions";
  ...
  describe('Reducer', () => {
    describe('rentBasisReducer', () => {
      ...
      it('should update rent basis list', () => {
        ...
        const state = rentBasisReducer({}, receiveRentBasisList({
          results: dummyRentBasisList
        }));
        expect(state).to.deep.equal(newState);
      });
