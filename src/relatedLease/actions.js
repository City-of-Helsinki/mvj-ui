...
export const createRelatedPlotApplication = (payload: CreateRelatedPlotApplicationPayload): CreateRelatedPlotApplicationAction =>
  createAction('mvj/relatedLease/CREATE_PLOT_APPLICATION')(payload);

export const deleteRelatedPlotApplication = (payload: DeleteRelatedPlotApplicationPayload): DeleteRelatedPlotApplicationAction =>
