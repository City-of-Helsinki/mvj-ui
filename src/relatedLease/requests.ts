...
export const createRelatedLease = (
  payload: CreateRelatedLeasePayload,
): Generator<any, any, any> => {
  const body = JSON.stringify(payload);
  return callApi(
    new Request(createUrl(`related_lease/`), {
      method: "POST",
      body,
    }),
  );
...
export const deleteReleatedLease = (id: number): Generator<any, any, any> => {
  return callApi(
    new Request(createUrl(`related_lease/${id}/`), {
      method: "DELETE",
    }),
  );
};
export const createRelatedPlotApplication = (
  ...
  const body = JSON.stringify(payload);
  return callApi(
    new Request(createUrl(`related_plot_applications/`), {
      method: "POST",
      body,
    }),
  );
...
export const deleteRelatedPlotApplication = (
  ...
  return callApi(
    new Request(createUrl(`related_plot_applications/${id}/`), {
      method: "DELETE",
    }),
  );
};
