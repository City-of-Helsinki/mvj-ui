...
import { getAttributes as getInfillDevelopmentAttributes, getFormInitialValues, getIsSaveClicked } from "@/infillDevelopment/selectors";
          ...
          <Row>
            <Column small={6} medium={4} large={2}>
              <Authorization allow={isFieldAllowedToRead(infillDevelopmentAttributes, InfillDevelopmentCompensationFieldPaths.NAME)}>
                <FormField disableTouched={isSaveClicked} fieldAttributes={getFieldAttributes(infillDevelopmentAttributes, InfillDevelopmentCompensationFieldPaths.NAME)} name='name' setRefForField={this.setRefForFirstField} overrideValues={{
                label: InfillDevelopmentCompensationFieldTitles.NAME
              }} enableUiDataEdit uiDataKey={getUiDataInfillDevelopmentKey(InfillDevelopmentCompensationFieldPaths.NAME)} />
              </Authorization>
            </Column>
            <Column small={6} medium={4} large={2}>
              <Authorization allow={isFieldAllowedToRead(infillDevelopmentAttributes, InfillDevelopmentCompensationFieldPaths.DETAILED_PLAN_IDENTIFIER)}>
                <FormField disableTouched={isSaveClicked} fieldAttributes={getFieldAttributes(infillDevelopmentAttributes, InfillDevelopmentCompensationFieldPaths.DETAILED_PLAN_IDENTIFIER)} name='detailed_plan_identifier' overrideValues={{
                label: InfillDevelopmentCompensationFieldTitles.DETAILED_PLAN_IDENTIFIER
              }} enableUiDataEdit uiDataKey={getUiDataInfillDevelopmentKey(InfillDevelopmentCompensationFieldPaths.DETAILED_PLAN_IDENTIFIER)} />
              </Authorization>
            </Column>
            <Column small={6} medium={4} large={2}>
              <Authorization allow={isFieldAllowedToRead(infillDevelopmentAttributes, InfillDevelopmentCompensationFieldPaths.REFERENCE_NUMBER)}>
                <FormField disableTouched={isSaveClicked} fieldAttributes={getFieldAttributes(infillDevelopmentAttributes, InfillDevelopmentCompensationFieldPaths.REFERENCE_NUMBER)} name='reference_number' validate={referenceNumber} overrideValues={{
                label: InfillDevelopmentCompensationFieldTitles.REFERENCE_NUMBER,
                fieldType: FieldTypes.REFERENCE_NUMBER
              }} enableUiDataEdit uiDataKey={getUiDataInfillDevelopmentKey(InfillDevelopmentCompensationFieldPaths.REFERENCE_NUMBER)} />
              </Authorization>
            </Column>
            <Column small={6} medium={4} large={2}>
              <Authorization allow={isFieldAllowedToRead(infillDevelopmentAttributes, InfillDevelopmentCompensationFieldPaths.STATE)}>
                <FormField disableTouched={isSaveClicked} fieldAttributes={getFieldAttributes(infillDevelopmentAttributes, InfillDevelopmentCompensationFieldPaths.STATE)} name='state' overrideValues={{
                label: InfillDevelopmentCompensationFieldTitles.STATE
              }} enableUiDataEdit uiDataKey={getUiDataInfillDevelopmentKey(InfillDevelopmentCompensationFieldPaths.STATE)} />
              </Authorization>
            </Column>
          </Row>
          <Row>
            <Column small={6} medium={4} large={2}>
              <Authorization allow={isFieldAllowedToRead(infillDevelopmentAttributes, InfillDevelopmentCompensationFieldPaths.USER)}>
                <FormField disableTouched={isSaveClicked} fieldAttributes={getFieldAttributes(infillDevelopmentAttributes, InfillDevelopmentCompensationFieldPaths.USER)} name='user' overrideValues={{
                fieldType: FieldTypes.USER,
                label: InfillDevelopmentCompensationFieldTitles.USER
              }} enableUiDataEdit uiDataKey={getUiDataInfillDevelopmentKey(InfillDevelopmentCompensationFieldPaths.USER)} />
              </Authorization>
            </Column>
            <Column small={6} medium={4} large={2}>
              <Authorization allow={isFieldAllowedToRead(infillDevelopmentAttributes, InfillDevelopmentCompensationFieldPaths.LEASE_CONTRACT_CHANGE_DATE)}>
                <FormField disableTouched={isSaveClicked} fieldAttributes={getFieldAttributes(infillDevelopmentAttributes, InfillDevelopmentCompensationFieldPaths.LEASE_CONTRACT_CHANGE_DATE)} name='lease_contract_change_date' overrideValues={{
                label: InfillDevelopmentCompensationFieldTitles.LEASE_CONTRACT_CHANGE_DATE
              }} enableUiDataEdit uiDataKey={getUiDataInfillDevelopmentKey(InfillDevelopmentCompensationFieldPaths.LEASE_CONTRACT_CHANGE_DATE)} />
              </Authorization>
            </Column>
            <Column small={12} medium={4} large={8}>
              <Authorization allow={isFieldAllowedToRead(infillDevelopmentAttributes, InfillDevelopmentCompensationFieldPaths.NOTE)}>
                <FormField disableTouched={isSaveClicked} fieldAttributes={getFieldAttributes(infillDevelopmentAttributes, InfillDevelopmentCompensationFieldPaths.NOTE)} name='note' overrideValues={{
                label: InfillDevelopmentCompensationFieldTitles.NOTE
              }} enableUiDataEdit uiDataKey={getUiDataInfillDevelopmentKey(InfillDevelopmentCompensationFieldPaths.NOTE)} />
              </Authorization>
            </Column>
          </Row>
