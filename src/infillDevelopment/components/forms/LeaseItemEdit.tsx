      ...
      {({ dispatch }) => {
        return (
          <Fragment>
            ...
            {!hasPermissions(
              usersPermissions,
              UsersPermissions.ADD_INFILLDEVELOPMENTCOMPENSATIONDECISION,
            ) &&
                      ...
                      <Column small={3} large={2}>
                        <Authorization
                          allow={hasPermissions(
                            usersPermissions,
                            UsersPermissions.DELETE_INFILLDEVELOPMENTCOMPENSATIONDECISION,
                          )}
                        >
                          <RemoveButton
      ...
      {({ dispatch }) => {
        return (
          <Fragment>
            ...
            {!hasPermissions(
              usersPermissions,
              UsersPermissions.ADD_INFILLDEVELOPMENTCOMPENSATIONINTENDEDUSE,
            ) &&
              (!fields || !fields.length) && (
                ...
                {fields.map((field, index) => {
                  const handleRemove = () => {
                    dispatch({
                      ...
                      confirmationModalButtonClassName: ButtonColors.ALERT,
                      confirmationModalButtonText:
                        ConfirmationModalTexts.DELETE_INTENDED_USE.BUTTON,
                      confirmationModalLabel:
                        ConfirmationModalTexts.DELETE_INTENDED_USE.LABEL,
                      confirmationModalTitle:
                        ConfirmationModalTexts.DELETE_INTENDED_USE.TITLE,
                    });
                  };
                    ...
                    <Row key={index}>
                      ...
                      <Column small={3} large={2}>
                        <Authorization
                          allow={hasPermissions(
                            usersPermissions,
                            UsersPermissions.DELETE_INFILLDEVELOPMENTCOMPENSATIONINTENDEDUSE,
                          )}
                        >
                          <RemoveButton
                            className="third-level"
  ...
  getTotalCompensation = () => {
    ...
    return (
      (formatedCompensationInvestment && !isNaN(formatedCompensationInvestment)
        ...
        : 0) +
      (formatedMonetaryCompensation && !isNaN(formatedMonetaryCompensation)
