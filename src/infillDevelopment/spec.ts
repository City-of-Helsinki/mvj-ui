...
import { fetchInfillDevelopments, fetchSingleInfillDevelopment, hideEditMode, notFound, fetchAttributes, attributesNotFound, receiveAttributes, receiveMethods, receiveInfillDevelopments, receiveSingleInfillDevelopment, receiveFormInitialValues, createInfillDevelopment, editInfillDevelopment, showEditMode, receiveFormValidFlags, clearFormValidFlags, receiveIsSaveClicked, receiveCollapseStates } from "./actions";
  ...
  describe('Reducer', () => {
    ...
    describe('infillDevelopmentReducer', () => {
      ...
      it('should update isFetchingAttributes flag to false by attributesNotFound', () => {
        ...
        let state: Record<string, any> = infillDevelopmentReducer({}, fetchAttributes());
      ...
      it('should clear isFormValidById value', () => {
        ...
        let state: Record<string, any> = infillDevelopmentReducer({}, receiveFormValidFlags(dummyFlags));
      ...
      it('should update collapseStates', () => {
        ...
        let state: Record<string, any> = infillDevelopmentReducer({}, receiveCollapseStates({
          foo: 'bar'
        }));
        state = infillDevelopmentReducer(state, receiveCollapseStates({
          foo2: 'bar2'
        }));
        expect(state).to.deep.equal(newState);
      });
