  ...
  describe("Reducer", () => {
    describe("infillDevelopmentReducer", () => {
      ...
      it("should update isFetchingAttributes flag to false by attributesNotFound", () => {
        ...
        let state: Record<string, any> = infillDevelopmentReducer(
          {},
          fetchAttributes(),
        );
      ...
      it("should update attributes", () => {
        ...
        const state = infillDevelopmentReducer(
          {},
      ...
      it("should update infill development list", () => {
        ...
        const state = infillDevelopmentReducer(
          {},
          receiveInfillDevelopments(dummyInfillDevelopmentList),
        );
        expect(state).to.deep.equal(newState);
      });
      it("should update current infill development", () => {
        ...
        const state = infillDevelopmentReducer(
          {},
          receiveSingleInfillDevelopment(dummyInfillDevelopment),
        );
        expect(state).to.deep.equal(newState);
      });
      it("should update form initial values", () => {
        ...
        const state = infillDevelopmentReducer(
          {},
          receiveFormInitialValues(dummyInfillDevelopment),
        );
        expect(state).to.deep.equal(newState);
      });
      ...
      it("should update isFetching flag to true when fetching single infill development", () => {
        ...
        const state = infillDevelopmentReducer(
          {},
          fetchSingleInfillDevelopment(1),
        );
        expect(state).to.deep.equal(newState);
      });
      ...
      it("should update isFormValidById value", () => {
        ...
        const state = infillDevelopmentReducer(
          {},
          receiveFormValidFlags(dummyFlags),
        );
        expect(state).to.deep.equal(newState);
      });
      ...
      it("should update collapseStates", () => {
        ...
        state = infillDevelopmentReducer(
          state,
          receiveCollapseStates({
            foo2: "bar2",
          }),
