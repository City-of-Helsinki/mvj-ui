...
const attributesReducer: Reducer<Attributes> = handleActions({
  ['mvj/infillDevelopment/RECEIVE_ATTRIBUTES']: (state: Attributes, {
    payload: attributes
...
const methodsReducer: Reducer<Methods> = handleActions({
  ['mvj/infillDevelopment/RECEIVE_METHODS']: (state: Attributes, {
    payload: methods
...
const infillDevelopmentListReducer: Reducer<InfillDevelopmentList> = handleActions({
  ['mvj/infillDevelopment/RECEIVE_ALL']: (state: InfillDevelopmentList, {
    payload: infillDevelopments
...
const currentInfillDevelopmentReducer: Reducer<InfillDevelopment> = handleActions({
  ['mvj/infillDevelopment/RECEIVE_SINGLE']: (state: InfillDevelopment, {
...
const initialValuesReducer: Reducer<InfillDevelopment> = handleActions({
  ['mvj/infillDevelopment/RECEIVE_INITIAL_VALUES']: (state: InfillDevelopment, {
    payload: infillDevelopment
...
const isSaveClickedReducer: Reducer<boolean> = handleActions({
  ['mvj/infillDevelopment/RECEIVE_SAVE_CLICKED']: (state: boolean, {
    payload: isClicked
...
const isFormValidByIdReducer: Reducer<Record<string, any>> = handleActions({
  ['mvj/infillDevelopment/RECEIVE_FORM_VALID_FLAGS']: (state: Record<string, any>, {
    payload: valid
...
const collapseStatesReducer: Reducer<Record<string, any>> = handleActions({
  ['mvj/infillDevelopment/RECEIVE_COLLAPSE_STATES']: (state: Record<string, any>, {
    payload: states
