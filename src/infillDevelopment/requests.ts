...
export const fetchInfillDevelopments = (query: Record<string, any>): Generator<any, any, any> => {
  return callApi(new Request(createUrl('infill_development_compensation/', query)));
};
