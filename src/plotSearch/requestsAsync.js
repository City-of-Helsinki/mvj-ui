...
export const fetchPlanUnitListWithIdentifiersList = async(query?: Object): Promise<Array<Object>> => {
...
export const fetchCustomDetailedPlanListWithIdentifiersList = async(query?: Object): Promise<Array<Object>> => {
  const {response: {status}, bodyAsJson} = await callApiAsync(new Request(createUrl('custom_detailed_plan_list_with_identifiers/', query)));
