...
type Props = {
  ...
  createDirectReservationLink: Function;
};
...
class DirectReservationLinkModal extends Component<Props> {
  ...
  handleSubmit = () => {
    ...
    createDirectReservationLink({data: formValues, callBack: onClose});
  };
        ...
        <Row>
          <Column large={12}>
            <FormField
              ...
              overrideValues={{
                options: [{value: true, label: 'Kyllä'}],
              }}
              name="send_copy"
            />
          </Column>
...
)(DirectReservationLinkModal): React$ComponentType<OwnProps>);
