          ...
          <Authorization allow={isFieldAllowedToRead(applicationAttributes, PlotApplicationOpeningRecordPaths.CREATED_BY)}>
            <Column small={6} medium={3} large={2}>
              <FormField
                ...
                fieldAttributes={get(applicationAttributes, PlotApplicationOpeningRecordPaths.CREATED_BY)}
                overrideValues={{
          ...
          <Authorization allow={isFieldAllowedToRead(applicationAttributes, PlotApplicationOpeningRecordPaths.OPENERS)}>
            <Column small={12} medium={12} large={4}>
              <FormField
                ...
                fieldAttributes={get(applicationAttributes, PlotApplicationOpeningRecordPaths.OPENERS)}
                overrideValues={{
          ...
          <Authorization allow={isFieldAllowedToRead(applicationAttributes, PlotApplicationOpeningRecordPaths.NOTE)}>
            <Column small={12}>
              <FormField
                ...
                fieldAttributes={get(applicationAttributes, PlotApplicationOpeningRecordPaths.NOTE)}
                overrideValues={{
...
)(PlotSearchApplicationsOpeningSection): React$ComponentType<Props>);
