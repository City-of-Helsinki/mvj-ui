...
type Props = {
  ...
  plotSearchSiteErrors: Array<Object>,
      ...
      >
        <Row>
          <Column small={6} medium={3} large={3}>
            ...
            {(isFetchingCustomDetailedPlanAttributes || isFetchingCustomDetailedPlan) &&
          ...
          {usageDistributions.length > 0 && (<Column small={12} medium={12} large={12} className="plot_search_target__info-links">
            ...
            {usageDistributions.map((usageDistribution) => <Row key={usageDistribution.distribution}>
              ...
              <Column small={8} medium={6} large={6}>
                <FormText>
                  {usageDistribution.build_permission ? `${usageDistribution.build_permission} m²` : '-'}
                </FormText>
              </Column>
              <Column small={4} medium={2} large={2}>
                <FormText>
