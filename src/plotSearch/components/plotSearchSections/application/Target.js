...
class Target extends PureComponent<Props, State> {
  ...
  render (){
    ...
    const targetPlotSearchOptions = getFieldOptions(attributes, 'application_base.child.children.target.child.children.target_plotSearch');
      ...
      <Fragment>
        ...
        <Row>
          <Column small={6} medium={4} large={2}>
            ...
            <FormText>{getLabelOfOption(targetPlotSearchOptions, target.target_plotSearch) || '-'}</FormText>
          </Column>
          <Column small={6} medium={4} large={2}>
