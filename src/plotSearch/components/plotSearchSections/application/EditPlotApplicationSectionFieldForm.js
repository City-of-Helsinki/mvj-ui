...
type ChoiceProps = {
  ...
  fields: Fields,
  change: Function,
  onChoiceValuesChanged: Function,
...
const EditPlotApplicationSectionFieldChoice = ({
  ...
  autoFillValues,
  protectedValues,
}: ChoiceProps): React$Node => {
  const choiceRefs = useRef({});

  const getDataMapBase = (): {[key: string]: any} => fields.getAll().reduce((acc, item) => ({
    ...acc,
        ...
        <Row>
          ...
          <Column small={10}>
            <Row>
              <Column small={4}>
                <FormField
                  fieldAttributes={get(attributes, 'sections.child.children.fields.child.children.choices.child.children.text')}
                  name={`${field}.text`}
                  disabled={disabled}
                  overrideValues={{
                    label: 'Nimi suomeksi',
              ...
              <Column small={4}>
                <FormField
                  fieldAttributes={get(attributes, 'sections.child.children.fields.child.children.choices.child.children.text_en')}
                  name={`${field}.text_en`}
                  disabled={disabled}
                  overrideValues={{
              ...
              <Column small={4}>
                <FormField
                  fieldAttributes={get(attributes, 'sections.child.children.fields.child.children.choices.child.children.text_sv')}
                  name={`${field}.text_sv`}
                  disabled={disabled}
                  overrideValues={{
          ...
          <Column small={1}>
            ...
            <IconButton
              ...
              ref={(el) => setRef(`SectionEditorMoveUpButton_Choice_${i}`, el)}
            >
            ...
            <IconButton
              ...
              ref={(el) => setRef(`SectionEditorMoveDownButton_Choice_${i}`, el)}
            >
        ...
        <Row>
          ...
          <Column small={10}>
            <Row>
              <Column small={6}>
                <FormField
                  fieldAttributes={get(attributes, 'sections.child.children.fields.child.children.choices.child.children.value')}
                  name={`${field}.value`}
              ...
              <Column small={6}>
                <FormField
                  fieldAttributes={get(attributes, 'sections.child.children.fields.child.children.choices.child.children.has_text_input')}
...
type OwnProps = {
  ...
  setSectionEditorCollapseState: Function,
};
...
type Props = {
  ...
  attributes: Attributes,
  fieldValues: Object,
  fieldTypeMapping: {[number]: string},
  change: Function,
...
const EditPlotApplicationSectionFieldForm = ({
  ...
  const typeChoices = useMemo<Array<Object>>(() => {
  ...
  const handleChoiceValuesChanged = (dataMap: {[string]: string}) => {
    if (fieldFeatures.includes(FieldTypeFeatures.MULTIPLE_SELECTION_OPTIONS)) {
  ...
  const optionChoices = useMemo<Object>(() => {
        ...
        <Row className="section-field-editor">
          <Column small={12}>
            <Row>
              <Column small={4}>
                <FormField
                  ...
                  onChange={(newName) => updateAutoIdentifier(
              ...
              <Column small={4}>
                <FormField
                  fieldAttributes={get(attributes, 'sections.child.children.fields.child.children.label_en')}
                  name={`${field}.label_en`}
                  disabled={disabled}
                  overrideValues={{
                    label: 'Nimi englanniksi',
              ...
              <Column small={4}>
                <FormField
                  fieldAttributes={get(attributes, 'sections.child.children.fields.child.children.label_sv')}
                  name={`${field}.label_sv`}
                  disabled={disabled}
                  overrideValues={{
                    label: 'Nimi ruotsiksi',
            ...
            <Row>
              <Column small={4}>
                <FormField
                  fieldAttributes={get(attributes, 'sections.child.children.fields.child.children.type')}
                  name={`${field}.type`}
                  disabled={disabled}
                  overrideValues={{
                    label: 'Tyyppi',
              ...
              <Column small={4}>
                <FormField
                  fieldAttributes={get(attributes, 'sections.child.children.fields.child.children.identifier')}
                  name={`${field}.identifier`}
                  disabled={disabled || fieldValues.auto_fill_identifier || fieldValues.is_protected}
                  overrideValues={{
            ...
            <Row>
              <Column small={4}>
                <FormField
                  fieldAttributes={get(attributes, 'sections.child.children.fields.child.children.hint_text')}
              ...
              <Column small={4}>
                <FormField
                  fieldAttributes={get(attributes, 'sections.child.children.fields.child.children.hint_text_en')}
              ...
              <Column small={4}>
                <FormField
                  fieldAttributes={get(attributes, 'sections.child.children.fields.child.children.hint_text_sv')}
            ...
            {(
              fieldFeatures.includes(FieldTypeFeatures.FREEFORM_DEFAULT_VALUE) ||
              fieldFeatures.includes(FieldTypeFeatures.LIST_SELECTION_DEFAULT_VALUE)
            ) && (<Row>
              <Column small={12}>
            ...
            <Row>
              {fieldFeatures.includes(FieldTypeFeatures.FREEFORM_DEFAULT_VALUE) && <Column
                small={fieldFeatures.includes(FieldTypeFeatures.TEXT_AREA_INPUT) ? 12 : 4}
              >
                <FormField
                  fieldAttributes={{
                    ...get(attributes, 'sections.child.children.fields.child.children.default_value'),
                    type: fieldFeatures.includes(FieldTypeFeatures.TEXT_AREA_INPUT)
                      ? FieldTypes.TEXTAREA
                      : FieldTypes.STRING,
                  }}
                  ...
                  disabled={disabled}
                  overrideValues={{
                    label: fieldFeatures.includes(FieldTypeFeatures.UNCHANGEABLE_VALUE)
                      ? 'Vakioarvo'
                      : 'Oletusarvo',
                  }}
                />
            ...
            {(
              fieldFeatures.includes(FieldTypeFeatures.SINGLE_SELECTION_OPTIONS) ||
              fieldFeatures.includes(FieldTypeFeatures.MULTIPLE_SELECTION_OPTIONS)
            ) && <>
              <Row>
                <Column small={12}>
              ...
              <Row>
                <Column small={4}>
                  <FormField
                    ...
                    disabled={disabled || fieldValues.protected_values.length > 0}
                    invisibleLabel
                    overrideValues={{
                      options: [{
...
)(EditPlotApplicationSectionFieldForm): React$ComponentType<OwnProps>);
