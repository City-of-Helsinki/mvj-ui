...
export const fetchAttributes = (): FetchAttributesAction => createAction('mvj/plotSearch/FETCH_ATTRIBUTES')();
export const receiveMethods = (methods: Methods): ReceiveMethodsAction => createAction('mvj/plotSearch/RECEIVE_METHODS')(methods);
export const attributesNotFound = (): PlotSearchAttributesNotFoundAction => createAction('mvj/plotSearch/ATTRIBUTES_NOT_FOUND')();
export const receiveAttributes = (attributes: Attributes): ReceiveAttributesAction => createAction('mvj/plotSearch/RECEIVE_ATTRIBUTES')(attributes);
export const fetchPlotSearchList = (search: string): FetchPlotSearchListAction => createAction('mvj/plotSearch/FETCH_ALL')(search);
export const receivePlotSearchList = (list: PlotSearchList): ReceivePlotSearchListAction => createAction('mvj/plotSearch/RECEIVE_ALL')(list);
export const fetchSinglePlotSearch = (id: PlotSearchId): FetchSinglePlotSearchAction => createAction('mvj/plotSearch/FETCH_SINGLE')(id);
export const receiveSinglePlotSearch = (plotSearch: PlotSearch): ReceiveSinglePlotSearchAction => createAction('mvj/plotSearch/RECEIVE_SINGLE')(plotSearch);
export const editPlotSearch = (plotSearch: PlotSearch): EditPlotSearchAction => createAction('mvj/plotSearch/EDIT')(plotSearch);
export const fetchSinglePlotSearchAfterEdit = (payload: FetchSinglePlotSearchAfterEditPayload): FetchSinglePlotSearchAfterEditAction => createAction('mvj/plotSearch/FETCH_SINGLE_AFTER_EDIT')(payload);
export const createPlotSearch = (plotSearch: PlotSearch): CreatePlotSearchAction => createAction('mvj/plotSearch/CREATE')(plotSearch);
export const deletePlotSearch = (id: PlotSearchId): DeletePlotSearchAction => createAction('mvj/plotSearch/DELETE')(id);
export const hideEditMode = (): HideEditModeAction => createAction('mvj/plotSearch/HIDE_EDIT')();
export const showEditMode = (): ShowEditModeAction => createAction('mvj/plotSearch/SHOW_EDIT')();
export const receiveCollapseStates = (status: Record<string, any>): ReceiveCollapseStatesAction => createAction('mvj/plotSearch/RECEIVE_COLLAPSE_STATES')(status);
export const receiveIsSaveClicked = (isClicked: boolean): ReceiveIsSaveClickedAction => createAction('mvj/plotSearch/RECEIVE_SAVE_CLICKED')(isClicked);
export const receiveFormValidFlags = (valid: Record<string, any>): ReceiveFormValidFlagsAction => createAction('mvj/plotSearch/RECEIVE_FORM_VALID_FLAGS')(valid);
export const clearFormValidFlags = (): ClearFormValidFlagsAction => createAction('mvj/plotSearch/CLEAR_FORM_VALID_FLAGS')();
export const notFound = (): PlotSearchNotFoundAction => createAction('mvj/plotSearch/NOT_FOUND')();
...
export const fetchCustomDetailedPlan = (payload: Record<string, any>): FetchCustomDetailedPlanAction => createAction('mvj/plotSearch/FETCH_CUSTOM_DETAILED_PLAN')(payload);
export const receiveSingleCustomDetailedPlan = (customDetailedPlan: CustomDetailedPlan): ReceiveSingleCustomDetailedPlanAction => createAction('mvj/plotSearch/RECEIVE_CUSTOM_DETAILED_PLAN')(customDetailedPlan);
...
export const resetPlanUnitDecisions = (): ResetPlanUnitDecisionsAction => createAction('mvj/plotSearch/RESET_PLAN_UNIT_DECISIONS')();
export const fetchStages = (): FetchPlotSearchStagesAction => createAction('mvj/plotSearch/FETCH_PLOT_SEARCH_STAGES')();
export const receiveStages = (payload: Array<Record<string, any>>): ReceivePlotSearchStagesAction => createAction('mvj/plotSearch/RECEIVE_PLOT_SEARCH_STAGES')(payload);
export const stagesNotFound = (): PlotSearchStagesNotFoundAction => createAction('mvj/plotSearch/PLOT_SEARCH_STAGES_NOT_FOUND')();
export const batchCreateReservationIdentifiers = (payload: Array<Record<string, any>>): BatchCreateReservationIdentifiersAction => createAction('mvj/plotSearch/BATCH_CREATE_RESERVATION_IDENTIFIERS')(payload);
export const reservationIdentifiersCreated = (): ReservationIdentifiersCreatedAction => createAction('mvj/plotSearch/RESERVATION_IDENTIFIERS_CREATED')();
export const reservationIdentifiersCreationFailed = (payload: any): ReservationIdentifiersCreationFailedAction => createAction('mvj/plotSearch/RESERVATION_IDENTIFIERS_CREATION_FAILED')(payload);
export const fetchReservationIdentifierUnitLists = (): FetchReservationIdentifierUnitListsAction => createAction('mvj/plotSearch/FETCH_RESERVATION_IDENTIFIER_UNIT_LISTS')();
export const receiveReservationIdentifierUnitLists = (payload: Record<string, any>): ReceiveReservationIdentifierUnitListsAction => createAction('mvj/plotSearch/RECEIVE_RESERVATION_IDENTIFIER_UNIT_LISTS')(payload);
export const reservationIdentifierUnitListsNotFound = (): ReservationIdentifierUnitListsNotFoundAction => createAction('mvj/plotSearch/RESERVATION_IDENTIFIER_UNIT_LISTS_NOT_FOUND')();
