...
function* createLandUseAgreementAttachmentSaga({payload}): Generator<any, any, any> {
  try {
    const {response: {status: statusCode}, bodyAsJson} = yield call(createLandUseAgreementAttachment, payload);
...
function* deleteLandUseAgreementAttachmentSaga({payload}): Generator<any, any, any> {
  try {
    const {response: {status: statusCode}, bodyAsJson} = yield call(deleteLandUseAgreementAttachment, payload.fileId);
